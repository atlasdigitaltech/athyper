 ...
 */
export function registerKernelDefaults(
  container: Container,
  config: RuntimeConfig,
  options?: KernelDefaultsOptions,
) {
  // Kernel primitives
  ...
  container.register(
    TOKENS.bootId,
    async () => options?.bootId ?? "boot-unknown",
    "singleton",
  );
  ...
  container.register(
    TOKENS.auditWriter,
    async () => createConsoleAuditWriter(),
    "singleton",
  );
  ...
  container.register(
    ...
    async () => new HealthCheckRegistry(),
    "singleton",
  );
  container.register(
    TOKENS.metricsRegistry,
    async () => new MetricsRegistry(),
    "singleton",
  );
  container.register(
    TOKENS.requestContextStorage,
    async () => new RequestContextStorage(),
    "singleton",
  );
  container.register(
    TOKENS.gracefulShutdown,
    async () => new GracefulShutdown(),
    "singleton",
  );

  // Registries (definition buckets)
  container.register(
    TOKENS.serviceRegistry,
    async () => new ServiceRegistry(),
    "singleton",
  );
  container.register(
    TOKENS.routeRegistry,
    async () => new RouteRegistry(),
    "singleton",
  );
  container.register(
    TOKENS.jobRegistry,
    async () => new JobRegistry(),
    "singleton",
  );
}
