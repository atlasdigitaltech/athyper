 ...
 */
export function protectDbAdapter(
  adapter: DbAdapter,
  breakers: AdapterCircuitBreakers,
): DbAdapter {
  ...
  return {
    ...
    async withTxIsolation<T>(
      ...
      return breaker.execute(() =>
        withRetry(
          () => adapter.withTxIsolation(db, isolationLevel, fn),
          DB_RETRY_POLICY,
        ),
      );
    },
 ...
 */
export function protectCacheAdapter(
  adapter: any,
  breakers: AdapterCircuitBreakers,
): any {
 ...
 */
export function protectObjectStorageAdapter(
  adapter: any,
  breakers: AdapterCircuitBreakers,
): any {
  ...
  return {
    ...
    async getPresignedUrl(
      ...
      return breaker.execute(() =>
        withRetry(
          () => adapter.getPresignedUrl(key, expirySeconds),
          API_RETRY_POLICY,
        ),
      );
    },
    ...
    async putPresignedUrl(
      ...
      return breaker.execute(() =>
        withRetry(
          () => adapter.putPresignedUrl(key, expirySeconds),
          API_RETRY_POLICY,
        ),
      );
    },
    ...
    async copyObject(sourceKey: string, destKey: string): Promise<void> {
      return breaker.execute(() =>
        withRetry(
          () => adapter.copyObject(sourceKey, destKey),
          API_RETRY_POLICY,
        ),
      );
    },
 ...
 */
export function protectAuthAdapter(
  adapter: any,
  breakers: AdapterCircuitBreakers,
): any {
