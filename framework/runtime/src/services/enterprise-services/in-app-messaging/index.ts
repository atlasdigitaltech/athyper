...
class ListConversationsHandler {
  async handle(req: any, res: any, ctx: any) {
    const service = (await ctx.container.resolve(
      MSG_TOKENS.conversationService,
...
export const module: RuntimeModule = {
  ...
  async register(c: Container) {
    ...
    c.register(
      MSG_TOKENS.conversationService,
      async () => new ConversationService(db),
      "singleton",
    );
    c.register(
      MSG_TOKENS.messageService,
      async () => new MessageService(db),
      "singleton",
    );

    // Handlers
    c.register(
      MSG_TOKENS.listConversationsHandler,
      async () => new ListConversationsHandler(),
      "singleton",
    );
    c.register(
      MSG_TOKENS.getConversationHandler,
      async () => new GetConversationHandler(),
      "singleton",
    );
    c.register(
      MSG_TOKENS.createDirectHandler,
      async () => new CreateDirectHandler(),
      "singleton",
    );
    c.register(
      MSG_TOKENS.createGroupHandler,
      async () => new CreateGroupHandler(),
      "singleton",
    );
    c.register(
      MSG_TOKENS.sendMessageHandler,
      async () => new SendMessageHandler(),
      "singleton",
    );
    c.register(
      MSG_TOKENS.listMessagesHandler,
      async () => new ListMessagesHandler(),
      "singleton",
    );
    c.register(
      MSG_TOKENS.markReadHandler,
      async () => new MarkReadHandler(),
      "singleton",
    );
    c.register(
      MSG_TOKENS.markAllReadHandler,
      async () => new MarkAllReadHandler(),
      "singleton",
    );
    c.register(
      MSG_TOKENS.searchHandler,
      async () => new SearchHandler(),
      "singleton",
    );
    c.register(
      MSG_TOKENS.unreadCountHandler,
      async () => new UnreadCountHandler(),
      "singleton",
    );
    c.register(
      MSG_TOKENS.threadRepliesHandler,
      async () => new ThreadRepliesHandler(),
      "singleton",
    );
  },
