...
export const module: RuntimeModule = {
  ...
  async register(c: Container) {
    ...
    c.register(
      "fin.payments.paymentAllocationRepo",
      async () => {
    ...
    // ── Service ──
    c.register(
      "fin.payments.paymentEntryService",
      async () => {
        const paymentEntryRepo = await c.resolve<any>(
          "fin.payments.paymentEntryRepo",
        );
        const allocationRepo = await c.resolve<any>(
          "fin.payments.paymentAllocationRepo",
        );
        const purchaseInvoiceRepo = await c.resolve<any>(
        ...
        const taxCalcService = await c.resolve<any>(
          TOKENS.taxCalculationService,
        );
    ...
    // ── HTTP Handlers ──
    c.register(
      "fin.handler.pay.create",
      async () => new CreatePaymentHandler(),
      "singleton",
    );
    c.register(
      "fin.handler.pay.list",
      async () => new ListPaymentsHandler(),
      "singleton",
    );
    c.register(
      "fin.handler.pay.get",
      async () => new GetPaymentHandler(),
      "singleton",
    );
    c.register(
      "fin.handler.pay.update",
      async () => new UpdatePaymentHandler(),
      "singleton",
    );
    c.register(
      "fin.handler.pay.allocations",
      async () => new SetAllocationsHandler(),
      "singleton",
    );
    c.register(
      "fin.handler.pay.submit",
      async () => new SubmitPaymentHandler(),
      "singleton",
    );
    c.register(
      "fin.handler.pay.post",
      async () => new PostPaymentHandler(),
      "singleton",
    );
    c.register(
      "fin.handler.pay.cancel",
      async () => new CancelPaymentHandler(),
      "singleton",
    );
    c.register(
      "fin.handler.pay.reconcile",
      async () => new ReconcilePaymentHandler(),
      "singleton",
    );
  ...
  async contribute(c: Container) {
    ...
    routes.add({
      method: "POST",
      path: "/api/fin/payments",
      handlerToken: "fin.handler.pay.create",
      authRequired: true,
      tags: ["fin", "payment"],
    });
    routes.add({
      method: "GET",
      path: "/api/fin/payments",
      handlerToken: "fin.handler.pay.list",
      authRequired: true,
      tags: ["fin", "payment"],
    });
    routes.add({
      method: "GET",
      path: "/api/fin/payments/:id",
      handlerToken: "fin.handler.pay.get",
      authRequired: true,
      tags: ["fin", "payment"],
    });
    routes.add({
      method: "PATCH",
      path: "/api/fin/payments/:id",
      handlerToken: "fin.handler.pay.update",
      authRequired: true,
      tags: ["fin", "payment"],
    });
    routes.add({
      method: "POST",
      path: "/api/fin/payments/:id/allocations",
      handlerToken: "fin.handler.pay.allocations",
      authRequired: true,
      tags: ["fin", "payment"],
    });
    routes.add({
      method: "POST",
      path: "/api/fin/payments/:id/submit",
      handlerToken: "fin.handler.pay.submit",
      authRequired: true,
      tags: ["fin", "payment"],
    });
    routes.add({
      method: "POST",
      path: "/api/fin/payments/:id/post",
      handlerToken: "fin.handler.pay.post",
      authRequired: true,
      tags: ["fin", "payment"],
    });
    routes.add({
      method: "POST",
      path: "/api/fin/payments/:id/cancel",
      handlerToken: "fin.handler.pay.cancel",
      authRequired: true,
      tags: ["fin", "payment"],
    });
    routes.add({
      method: "POST",
      path: "/api/fin/payments/:id/reconcile",
      handlerToken: "fin.handler.pay.reconcile",
      authRequired: true,
      tags: ["fin", "payment"],
    });

    logger.info(
      "[fin.payments] Finance payments routes registered: 9 endpoints",
    );
  },
};
