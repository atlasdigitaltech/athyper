...
import type { ChartOfAccounts, CreateAccountInput, AccountType } from "../domain/types.js";
...
export interface ChartOfAccountsRepo {
    ...
    getByCode(tenantId: string, entityCode: string, accountCode: string): Promise<ChartOfAccounts | null>;
    update(tenantId: string, id: string, input: Partial<CreateAccountInput>): Promise<ChartOfAccounts>;
    ...
    }, pagination: PaginationParams): Promise<PaginatedResult<ChartOfAccounts>>;
