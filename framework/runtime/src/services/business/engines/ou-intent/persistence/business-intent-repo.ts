...
export interface BusinessIntentRepo {
    ...
    /** Update an intent */
    update(tenantId: string, id: string, input: Partial<CreateBusinessIntentInput>): Promise<BusinessIntent>;
    ...
    }, pagination: PaginationParams): Promise<PaginatedResult<BusinessIntent>>;
