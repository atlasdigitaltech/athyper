...
import type { PolicyDecision, WorkflowPath, CompositeScoreThresholds } from "./types.js";
 ...
 */
export function determineMostRestrictiveAction(decisions: PolicyDecision[]): PolicyDecision["action"] {
    const priority: Record<string, number> = { BLOCK: 0, ESCALATE: 1, REVIEW: 2, APPROVE: 3 };
 ...
 */
export function aggregateApprovers(decisions: PolicyDecision[]): PolicyDecision["approvers"] {
