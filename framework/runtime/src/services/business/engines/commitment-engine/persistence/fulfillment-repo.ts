...
import type { CommitmentFulfillment, CreateFulfillmentInput } from "../domain/types.js";
...
export interface CommitmentFulfillmentRepo {
    ...
    getByCommitmentId(tenantId: string, commitmentId: string): Promise<CommitmentFulfillment[]>;
    getByScheduleId(tenantId: string, scheduleId: string): Promise<CommitmentFulfillment[]>;
}
