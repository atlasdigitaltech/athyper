...
import { addMoney, compareMoney, subtractMoney, money } from "../../shared/money.js";
 ...
 */
export function canAcceptAction(fp: FundingProfile): { allowed: boolean; reason: string | null } {
    if (fp.status === "FROZEN") {
    ...
    if (fp.healthStatus === "BLACK") {
        return { allowed: false, reason: "Funding profile health is BLACK (fully consumed)" };
    }
