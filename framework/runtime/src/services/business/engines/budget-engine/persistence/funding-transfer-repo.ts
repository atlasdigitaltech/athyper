...
import type { FundingTransfer, CreateTransferInput, TransferStatus } from "../domain/types.js";
...
export interface FundingTransferRepo {
    ...
    updateStatus(tenantId: string, id: string, status: TransferStatus, approvedBy?: string): Promise<FundingTransfer>;
    list(tenantId: string, filters: {
        status?: TransferStatus;
        fromFpId?: string;
        toFpId?: string;
    }, pagination: PaginationParams): Promise<PaginatedResult<FundingTransfer>>;
}
