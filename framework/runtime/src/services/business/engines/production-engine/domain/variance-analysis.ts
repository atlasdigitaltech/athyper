 ...
 */
export function calculateMaterialVariances(
  input: VarianceInput,
): VarianceResult[] {
  ...
  const priceVariance =
    (input.actualRate - input.standardRate) * input.actualQty;
  results.push({
    varianceType: "PRICE",
    costType: "MATERIAL",
  ...
  const usageVariance =
    (input.actualQty - input.standardQty) * input.standardRate;
  results.push({
    varianceType: "USAGE",
    costType: "MATERIAL",
 ...
 */
export function calculateLaborVariances(
  input: VarianceInput,
): VarianceResult[] {
  const results: VarianceResult[] = [];
 ...
 */
export function calculateOverheadVariances(
  input: VarianceInput,
): VarianceResult[] {
