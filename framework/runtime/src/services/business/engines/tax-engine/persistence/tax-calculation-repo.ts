...
export interface TaxCalculationRepo {
    create(calc: Omit<TaxCalculation, "id" | "calculatedAt">): Promise<TaxCalculation>;
    createBatch(calcs: Omit<TaxCalculation, "id" | "calculatedAt">[]): Promise<TaxCalculation[]>;
    ...
    getByCommitmentId(tenantId: string, commitmentId: string): Promise<TaxCalculation[]>;
}
