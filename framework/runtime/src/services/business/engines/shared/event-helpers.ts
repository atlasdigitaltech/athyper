...
import type { PartitionDomain, DocType, ActorType, UniversalEventEnvelope } from "../event-store/domain/types.js";
 ...
 */
export async function verifyPayloadHash(payload: unknown, expectedHash: string): Promise<boolean> {
...
}): Omit<UniversalEventEnvelope<T>, "id" | "sequenceNo" | "payloadHash" | "createdAt" | "eventVersion"> {
    return {
