...
import { DEFAULT_DELIVERY_POLICY } from "../domain/models/DeliveryPolicy.js";

import type {
  OutboxItem,
  CreateOutboxItemInput,
} from "../domain/models/DeliveryPolicy.js";
...
export class OutboxRepo {
  ...
  async markFailed(
    ...
    const isDead =
      newRetryCount >=
      (item?.max_retries ?? DEFAULT_DELIVERY_POLICY.maxRetries);
