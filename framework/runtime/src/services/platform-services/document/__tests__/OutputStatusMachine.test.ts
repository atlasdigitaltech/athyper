...
describe("Output Status State Machine", () => {
  ...
  describe("classifyDocError", async () => {
    const { classifyDocError, DOC_ERROR_CODES } =
      await import("../domain/types.js");

    it("should classify timeout errors", () => {
      const result = classifyDocError(
    ...
    it("should classify template-not-found errors", () => {
      const result = classifyDocError(
        new Error("Template not found for code XYZ"),
      );
    ...
    it("should classify schema validation errors", () => {
      const result = classifyDocError(
        new Error("Template variable validation failed: missing x"),
      );
    ...
    it("should classify storage errors as transient", () => {
      const result = classifyDocError(
        new Error("Storage put failed: MinIO unreachable"),
      );
    ...
    it("should classify compose errors as permanent", () => {
      const result = classifyDocError(
        new Error("Template render error, bad compose step"),
      );
