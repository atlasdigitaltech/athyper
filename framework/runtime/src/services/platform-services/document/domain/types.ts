...
export type TemplateVersionId = string & {
  readonly __brand: "TemplateVersionId";
};
export type TemplateBindingId = string & {
  readonly __brand: "TemplateBindingId";
};
...
export type TemplateEngine = "HANDLEBARS" | "MJML" | "REACT_PDF";
...
export type DocErrorCode =
  (typeof DOC_ERROR_CODES)[keyof typeof DOC_ERROR_CODES];
 ...
 */
export function classifyDocError(error: unknown): {
  code: DocErrorCode;
 ...
 *                                └──→ ARCHIVED
 */
export const OUTPUT_STATUS_TRANSITIONS: Record<
  OutputStatus,
  readonly OutputStatus[]
> = {
