...
export class TelMetrics {
  ...
  callDuration(
    ...
    labels: { tenant: string; direction: string },
  ): void {
    this.registry.recordHistogram(
      "tel_call_duration_seconds",
      durationSeconds,
      labels,
    );
  }
