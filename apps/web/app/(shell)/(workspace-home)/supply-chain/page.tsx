...
const SUPPLY_CHAIN_ENTITIES = [
  ...
  },
  {
    ...
    description: "Supplier and customer identity management",
    icon_key:    "building-2",
    color_token: "blue",
  },
  {
    href:        "/app/business_partner/new",
    title:       "Create or Extend BP",
    description: "Duplicate check, intake, role and company-code extension",
    icon_key:    "users",
    color_token: "teal",
  },
  {
