    ...
    <div className="w-full">
      <Card className="w-full">
        <CardContent className="flex w-full flex-col items-center py-12 text-center">
          ...
          <p className="mb-1 text-sm font-semibold text-foreground">{formatMessage({ id: "settings.docs.title" })}</p>
          <p className="mb-6 max-w-xs text-xs text-muted-foreground">
            {formatMessage({ id: "settings.docs.description" })}
          </p>
          <Button className="gap-2 text-sm">
            <ExternalLink className="h-4 w-4" /> {formatMessage({ id: "settings.docs.button" })}
          </Button>
        </CardContent>
      </Card>
    </div>
