...
const ALLOWED = ["scopeType", "scopeId", "fiscalYear", "period", "bookId", "status", "limit", "offset"] as const;
...
export async function GET(req: Request) {
  ...
  try {
    ...
    const res = await fetch(`${RUNTIME_API_URL}/api/finance/ar/invoices?${qs}`, {
    ...
    console.error("[api/finance/ar/invoices]", e instanceof Error ? e.message : e);
