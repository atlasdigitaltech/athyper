...
export async function GET(req: Request) {
  ...
  try {
    ...
    const suffix = qs ? `?${qs}` : "";
    const res = await fetch(`${RUNTIME_API_URL}/api/finance/commodity-categories${suffix}`, {
    ...
    console.error("[api/finance/commodity-categories]", e instanceof Error ? e.message : e);
