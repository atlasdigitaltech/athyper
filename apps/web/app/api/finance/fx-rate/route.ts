...
const ALLOWED = [
  "from", "to", "asOf", "as_of", "rateType", "rate_type",
] as const;
...
export async function GET(req: Request) {
  ...
  try {
    ...
    const res = await fetch(`${RUNTIME_API_URL}/api/finance/fx-rate?${qs}`, {
    ...
    console.error("[api/finance/fx-rate GET]", e instanceof Error ? e.message : e);
