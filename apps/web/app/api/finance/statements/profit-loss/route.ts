...
export async function GET(req: Request) {
  ...
  try {
    ...
    const res = await fetch(`${RUNTIME_API_URL}/api/finance/statements/profit-loss?${qs}`, {
    ...
    console.error("[api/finance/statements/profit-loss]", e instanceof Error ? e.message : e);
