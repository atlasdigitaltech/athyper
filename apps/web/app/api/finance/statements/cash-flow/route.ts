...
export async function GET(req: Request) {
  ...
  try {
    ...
    const res = await fetch(`${RUNTIME_API_URL}/api/finance/statements/cash-flow?${qs}`, {
    ...
    console.error("[api/finance/statements/cash-flow]", e instanceof Error ? e.message : e);
