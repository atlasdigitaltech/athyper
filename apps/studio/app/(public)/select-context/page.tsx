...
export default async function SelectContextPage({ searchParams }: { readonly searchParams: Promise<{ readonly returnTo?: string }> }) { const returnTo=sanitizeReturnTo((await searchParams).returnTo); return <ContextGatePage plane="studio" returnTo={returnTo} contexts={await loadContexts(returnTo)} />; }
