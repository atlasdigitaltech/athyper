import { ACTIVITY_CENTER_RELAY_OPERATIONS, ATLAS_ANSWER_RELAY_OPERATIONS, BUSINESS_PARTNER_REQUEST_RELAY_OPERATIONS, createRelayHandler, ENTITY_LIST_DESCRIPTOR_OPERATION, ENTITY_LIST_QUERY_OPERATION, ENTITY_RECORD_RUNTIME_RELAY_OPERATIONS, EXPERIENCE_BOOTSTRAP_OPERATION, EXPERIENCE_SURFACE_RUNTIME_RELAY_OPERATIONS, IAM_ME_OPERATION, NEON_BP_PROFILE_MATCH_RELAY_OPERATIONS, NEON_BP_PROFILE_PROJECTION_RELAY_OPERATIONS, NEON_OPERATING_ORGANIZATIONS_OPERATION, NEON_WORK_CONTEXTS_OPERATION, PRINCIPAL_LOCALE_UPDATE_OPERATION, RECORD_BOOKMARK_RELAY_OPERATIONS, RECORD_TRANSFER_RELAY_OPERATIONS, type RelayHandler } from "@athyper/platform-gateway-bff-relay";
...
export const platformRelay: RelayHandler = (request, context) => {
  relay ??= createRelayHandler({
    ...
    operations: [IAM_ME_OPERATION, EXPERIENCE_BOOTSTRAP_OPERATION, PRINCIPAL_LOCALE_UPDATE_OPERATION, ...EXPERIENCE_SURFACE_RUNTIME_RELAY_OPERATIONS, ...ATLAS_ANSWER_RELAY_OPERATIONS, NEON_WORK_CONTEXTS_OPERATION, NEON_OPERATING_ORGANIZATIONS_OPERATION, ENTITY_LIST_DESCRIPTOR_OPERATION, ENTITY_LIST_QUERY_OPERATION, ...ENTITY_RECORD_RUNTIME_RELAY_OPERATIONS, ...BUSINESS_PARTNER_REQUEST_RELAY_OPERATIONS, ...NEON_BP_PROFILE_PROJECTION_RELAY_OPERATIONS, ...NEON_BP_PROFILE_MATCH_RELAY_OPERATIONS, ...RECORD_BOOKMARK_RELAY_OPERATIONS, ...RECORD_TRANSFER_RELAY_OPERATIONS, ...ACTIVITY_CENTER_RELAY_OPERATIONS],
    session: {
