...
import { createAuthenticatedOperationReview } from "@athyper/platform-iam-governance-review/authenticated-operation-review";
import { authRuntime } from "./auth";
import { platformRelay } from "./relay";

let handler: ReturnType<typeof createAuthenticatedOperationReview> | undefined;
export const operationReview = (request: Request) => {
  handler ??= createAuthenticatedOperationReview({
