...
export const metadata: Metadata = { applicationName: brand.applicationName, title: { default: brand.title, template: `%s | ${brand.title}` }, description: brand.description, manifest: brand.manifest, icons: { icon: [{ url: brand.favicon, type: "image/png", sizes: "64x64" }], apple: [{ url: brand.appleTouchIcon, type: "image/png", sizes: "64x64" }] } };
