...
export default function NeonHomePage() {
  return <PlatformHome
    ...
    searchItems={[
      ...
      { title: "Onboarding requests", description: "Review validation and approval requests", href: "/mdg/business-partner/requests", category: "Work", keywords: ["pending approval", "review", "workflow"], access: REQUEST_READ_ACCESS },
