  ...
  return (
    <WorkspaceDashboard>
      ...
      <WorkspaceCardGrid className="gap-4 lg:grid-cols-3">
        ...
        <PrimaryArea icon={Landmark} title="Finance Workbench" description="Finance settings, configuration review, opening balances, period close and diagnostics." href="/workbench/finance" />
      </WorkspaceCardGrid>
      ...
      <section className="grid gap-4 xl:grid-cols-[minmax(0,1.4fr)_minmax(320px,0.6fr)]">
        <WorkspaceDashboardSection panel title="Finance operations" description="Daily execution, controls and period-end work."><div className="grid gap-2 sm:grid-cols-2">{[
          ["Review configuration", "Review setup findings and backend posting gates", "/workbench/finance/readiness", ShieldCheck],
