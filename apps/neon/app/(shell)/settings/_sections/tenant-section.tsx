  ...
  return (
    <div className="w-full">
      ...
      >
        <div className="grid grid-cols-1 gap-x-8 sm:grid-cols-2">
          ...
          <div>
            ...
            <InfoRow label="Fiscal Year Start"  value={tp?.["fiscal_year_start_month"] ? `Month ${String(tp["fiscal_year_start_month"])}` : "—"} hint="Month number of fiscal year start" />
      ...
      <SectionCard
        ...
        icon={Layers}
        badge={<Badge variant="secondary" className="text-xs">{data?.modules.length ?? 0} modules</Badge>}
