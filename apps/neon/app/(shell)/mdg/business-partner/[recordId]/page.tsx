    ...
    <>
      <div className="bp-actions">
        <a
          ...
          href={`/mdg/business-partner/${encodeURIComponent(recordId)}/scope/new`}
        >
          Assign organization / configure company
        </a>
        <a
          className="a-button a-button--secondary"
          href={`/mdg/business-partner/${encodeURIComponent(recordId)}/customer`}
        >
          Customer credit & lifecycle
        </a>
        <a
          className="a-button a-button--primary"
          href={`/mdg/business-partner/${encodeURIComponent(recordId)}/roles/new`}
        >
          Add supplier/customer role
        </a>
      </div>
      <BusinessPartnerRecord businessPartnerId={recordId} />
    </>
  );
}
