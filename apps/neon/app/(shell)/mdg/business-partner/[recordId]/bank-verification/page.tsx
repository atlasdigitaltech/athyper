...
export default async function Page({params,searchParams}:{params:Promise<{recordId:string}>;searchParams:Promise<{companyCodeId?:string;bankProjectionId?:string}>}){
 ...
 return <BankingWorkspace businessPartnerId={recordId} mode="verification" initialCompanyCodeId={typeof query.companyCodeId==="string"?query.companyCodeId:""} initialBankProjectionId={typeof query.bankProjectionId==="string"?query.bankProjectionId:""}/>;
}
