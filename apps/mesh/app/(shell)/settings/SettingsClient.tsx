  ...
  useEffect(() => {
    ...
    fetch("/api/auth/session", { signal: controller.signal })
      ...
      .then((payload) => {
        ...
        const access = deriveSettingsAccess("mesh", payload);
  ...
  return (
    <MeUIProvider bffFetch={bffFetch} session={session}>
      <PageFrame
        ...
        title="Settings"
        description="Mesh account preferences, tenant context, diagnostics, and notification settings."
      >
        <SettingsWorkspace
          plane="mesh"
          path={path}
