...
export default function MeshHomePage() {
  return <PlatformHome
    ...
    searchItems={[
      ...
      { title: "Profile change requests", description: "Track governed profile submissions", href: "/mdg/business-partner/requests", category: "Work", keywords: ["priority tasks", "today’s work", "pending approvals", "update", "approval", "request"], access: MDG_ACCESS },
