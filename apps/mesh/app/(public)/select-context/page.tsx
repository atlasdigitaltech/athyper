...
export default async function SelectContextPage({ searchParams }: { readonly searchParams: Promise<{ readonly returnTo?: string }> }) { const returnTo=localRoute((await searchParams).returnTo); return <ContextGatePage plane="mesh" returnTo={returnTo} contexts={await loadContexts(returnTo)} />; }
