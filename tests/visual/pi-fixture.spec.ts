 ...
 *
 * Activation prerequisites (see tests/visual/README.md):
 *   1. Test tenant seeded with PI_FIXTURE_ID
 *   2. Auth: PLAYWRIGHT_USER + PLAYWRIGHT_PASSWORD set in env, OR
 *      `tests/visual/.auth/storage-state.json` committed for fixture tenant
...
const ACTIVATION_PENDING =
  "Dormant: complete the four activation prereqs in tests/visual/README.md, "
