...
const document = JSON.parse(readFileSync(join(root, "config/governance/server-p1-parity-manifest.json"), "utf8"));
const auditInventory = JSON.parse(readFileSync(join(root, "config/governance/server-audit-runtime-inventory.json"), "utf8"));
