...
for (const plane of ["neon", "mesh", "studio"]) {
  ...
  for (const asset of ["wordmark.png", "wordmark-inverse.png", "app-icon.png", "favicon.png", "manifest.webmanifest"]) if (!statSync(join(root, "apps", plane, "public", "brand", brand, asset)).isFile()) violations.push(`${plane} is missing production brand asset ${asset}`);
}
