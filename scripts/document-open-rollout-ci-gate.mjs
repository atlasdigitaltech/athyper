 ...
 *
 * Usage:
 *   node scripts/document-open-rollout-ci-gate.mjs --snapshot=./trace-snapshot.json
 *   node scripts/document-open-rollout-ci-gate.mjs --snapshot-json='{"minimumSamples":123,"metrics":{...}}'
