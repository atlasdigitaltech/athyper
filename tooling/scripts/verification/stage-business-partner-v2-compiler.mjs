...
const imageTag =
  process.argv[2] ?? "athyper/runtime:bp-v2-shadow-directory-20260911";
if (
  process.argv.length > 3 ||
  ![
    "athyper/runtime:bp-v2-shadow-directory-20260911",
...
const root =
  os.homedir() +
  "/.athyper/instances/dev/deployments/bp-v2-compiler-" +
  Date.now();
...
fs.writeFileSync("/tmp/bp-v2-compiler-root", root, { mode: 0o600 });
console.log(
  JSON.stringify({
    prepared: true,
    root,
