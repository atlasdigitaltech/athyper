...
const schema = readFileSync('server/db/scripts/operations/upgrades/legacy-baseline-20260914/20260910_entity_baseline_import.sql', 'utf8').replace(/^BEGIN;\s*/, '').replace(/COMMIT;\s*$/, '');
