...
const old = join(
  instance,
  "bp-governed-import-review-20260910/review.compose.json",
);
const root = join(instance, "bp-release-19-review-20260910"),
  review = join(root, "review");
mkdirSync(join(review, "output"), { recursive: true, mode: 0o700 });
const packetPath =
  "governance/policy/reviews/business-partner-release-19-workflow.dev.json";
const bytes = readFileSync(packetPath),
  packet = JSON.parse(bytes);
if (
  packet.releaseReview.coordinate.releaseId !==
    "ba383d04-9a18-4e59-ab4e-3d9726e934c6" ||
...
const report = {
  schemaVersion: 1,
  kind: "bp_release_19_review_deployment",
...
writeFileSync(
  "governance/policy/reports/business-partner-release-19-review-deployment.dev.json",
