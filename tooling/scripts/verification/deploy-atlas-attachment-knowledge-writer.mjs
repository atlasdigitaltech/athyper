...
const receipt={observedAt:new Date().toISOString(),environment:'dev',plane:'neon',migration:name,sha256:hash,applied:apply,runtimeHeadChanged:false};writeFileSync(`docs/examples/atlas-f5/cirrus-attachment-knowledge-writer.${apply?'applied':'dry-run'}.json`,JSON.stringify(receipt,null,2)+'\n');console.log(JSON.stringify(receipt));
