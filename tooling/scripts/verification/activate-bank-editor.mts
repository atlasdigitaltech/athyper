...
import { withBusinessPartnerBankEditor } from "../../../server/db/scripts/provisioning/business-partner-bank-editor.js";
...
const output = "governance/policy/reports/bank-editor-activation.dev.json";
...
try {
  ...
  const graph = withBusinessPartnerBankEditor(current.graph);
