...
const origin = "https://neon.dev.athyper.test",
  ...
  path =
    before ? "governance/policy/reports/task-rules-activation-gates-live.dev.json" : "governance/policy/reports/task-rules-activation-documents-live.dev.json";
const report: any = {
...
try {
  ...
  const cases = JSON.parse(
    readFileSync(
      before ? "governance/policy/reports/task-rules-journeys-live.dev.json" : "governance/policy/reports/supplier-process-submission-live.dev.json",
      "utf8",
    ),
