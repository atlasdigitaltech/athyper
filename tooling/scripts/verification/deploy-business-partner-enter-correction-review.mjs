...
const old = join(instance, "bp-release-20-review-20260911/review.compose.json");
const root = join(instance, "bp-enter-correction-review-20260911"),
...
if (
  packet.releaseReview.coordinate.releaseId !==
    "c2cc6900-26c1-47ca-8dfc-1d488000950c" ||
...
writeFileSync(
  "governance/policy/reports/business-partner-enter-correction-review-deployment.dev.json",
