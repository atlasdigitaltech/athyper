...
const name='20260910_operation_projection_release_identity.sql',migration=readFileSync(migrationSourcePath(name),'utf8'),hash=createHash('sha256').update(migration).digest('hex');
