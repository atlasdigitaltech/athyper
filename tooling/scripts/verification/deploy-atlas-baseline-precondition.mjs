...
const name='20260910_baseline_activation_precondition.sql',migration=readFileSync(migrationSourcePath(name),'utf8'),hash=createHash('sha256').update(migration).digest('hex');
