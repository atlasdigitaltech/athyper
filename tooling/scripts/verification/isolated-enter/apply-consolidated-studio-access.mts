...
const proposalPath =
  root +
  "reviews/business-partner-consolidated-studio-access-20260912.proposal.dev.json";
const approvalPath =
  root +
  "reviews/business-partner-consolidated-studio-access-20260912.user-approval.dev.json";
const output =
  root +
  "reports/business-partner-consolidated-studio-access-20260912.application.dev.json";
const p = JSON.parse(fs.readFileSync(proposalPath, "utf8"));
const { proposalRevision, ...body } = p;
assert.equal(
  proposalRevision,
  "a75351aca620ebc70d1619c4fffb98127e1ebed537ff03da3fbd93e14e66f4fb",
);
...
SELECT pg_advisory_xact_lock(hashtext('bp-consolidated-studio-access-20260912'));
