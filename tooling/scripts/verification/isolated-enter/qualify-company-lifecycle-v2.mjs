...
const approval = JSON.parse(
  fs.readFileSync(
    "governance/policy/reviews/business-partner-company-image-correction-v2-20260912.user-approval.dev.json",
  ),
);
assert.equal(approval.proposalRevision, amendment.proposalRevision);
assert.equal(approval.decision, "approved");
p.runtimeImage = amendment.runtimeImage;
p.releaseSetHash = amendment.releaseSetHash;
...
const output =
  "governance/policy/reports/business-partner-company-authenticated-lifecycle-v2-20260912.dev.json";
