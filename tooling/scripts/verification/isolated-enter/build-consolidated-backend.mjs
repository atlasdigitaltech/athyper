...
const root =
  os.homedir() +
  "/.athyper/instances/dev/deployments/bp-enter-isolated-20260911/consolidated-backend-build";
...
const report =
  "governance/policy/reports/business-partner-consolidated-backend-image-20260912.dev.json";
fs.writeFileSync(
  report,
  JSON.stringify(
    {
