...
const releaseId='ed6a7433-b41d-4ad8-8dda-44e1bdfba4a8',tenantId='44444444-4444-4444-8444-444444444444';
...
if (r.status) {
  ...
  const path =
    "governance/policy/reports/business-partner-company-case-signing-" +
    Date.now() +
    ".dev.json";
