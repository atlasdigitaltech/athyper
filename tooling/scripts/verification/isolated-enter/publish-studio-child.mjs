...
try {
  ...
  const result = await page.evaluate(async () => {
    ...
    const r = await fetch(
      "/api/relay/meta-entity-authoring/change-sets/9f56f0c1-3a18-4505-bba2-76f50c745132/publish",
      {
        method: "POST",
        headers: {
  ...
  const out =
    "governance/policy/reports/business-partner-child-native-publish-20260912." +
    Date.now() +
    ".dev.json";
  fs.writeFileSync(
    out,
