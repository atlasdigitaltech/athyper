...
const root =
  os.homedir() +
  "/.athyper/instances/dev/deployments/bp-enter-isolated-20260911/company-correction-backend-build-v1";
...
run(["tag", base, "athyper-bp-company-correction-base:20260912"]);
fs.writeFileSync(
  root + "/Dockerfile",
  "FROM athyper-bp-company-correction-base:20260912\nUSER root\nCOPY output/host/ /app/server/dist/\n" +
...
run([
  ...
  "--network=none",
  "-t",
  "athyper-bp-company-correction-backend:20260912",
  root,
]);
const image = run([
  "image",
