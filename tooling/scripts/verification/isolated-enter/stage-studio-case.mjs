...
try {
  ...
  const result = await page.evaluate(
    async ({ bundle }) => {
      ...
      const r = await fetch(
        "/api/relay/studio/business-partner-case-contracts",
        {
          method: "POST",
          headers: {
            ...
            "idempotency-key": "bp-case-initial-20260912-1811da8d",
          },
  ...
  const out =
    "governance/policy/reports/business-partner-case-initial-stage-20260912." +
    Date.now() +
    ".dev.json";
