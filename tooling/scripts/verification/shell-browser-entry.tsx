...
const params = new URLSearchParams(location.search), empty = params.has("empty"), multi = params.has("multi"), desktopBrand = params.has("desktopBrand"), locales = params.has("locales");
