...
const path =
  "governance/policy/reports/supplier-onboarding-closure-live.dev.json";
...
try {
  ...
  try {
    ...
    mkdirSync("governance/policy/reports/p6-browser", { recursive: true });
    for (const c of report.cases) {
      ...
      c.browser = {
        ...
        screenshot: `governance/policy/reports/p6-browser/${c.level}.png`,
      };
