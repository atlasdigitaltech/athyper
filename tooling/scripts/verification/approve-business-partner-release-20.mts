...
if (
  packet.packetRevision !==
    "4804e67680582faa99c18f9869ec0ce20a01b13047c6cb73f22ee275994d02ab" ||
...
const statePath = `tests/e2e/.auth/${account}-release-20-review.json`;
const fallbackPath = `tests/e2e/.auth/${account}-release-19-qualification.json`;
...
try {
  ...
  await context.storageState({
    path: `tests/e2e/.auth/${account}-release-20-review.json`,
  });
} catch (e) {
  console.log(
    JSON.stringify({
