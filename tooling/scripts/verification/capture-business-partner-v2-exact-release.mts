...
const id = "21bec59b-86fb-441c-93b2-5027f2999d0b";
...
const source = query(
  "athyper_studio",
  `SELECT to_jsonb(s)-'contract_signature' FROM publication.fn_authorization_successor_compilation_source('${id}') s;`,
);
const durable = query(
  "athyper_studio",
...
if (
  durable.changeSetId !== "f533b3ec-934b-4bc0-8448-ee933847ddf2" ||
