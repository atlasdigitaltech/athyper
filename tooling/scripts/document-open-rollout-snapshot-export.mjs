 ...
 *
 * Usage:
 *   node tooling/scripts/document-open-rollout-snapshot-export.mjs \
...
if (!inputPath || !outputPath) {
  console.error("Usage: node tooling/scripts/document-open-rollout-snapshot-export.mjs --input <raw-trace> --output <snapshot-json>");
  process.exit(2);
}
