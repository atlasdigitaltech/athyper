 ...
 *
 * Usage:
 *   node tooling/scripts/document-edit-runtime-har-gate.mjs ./purchase-invoice-edit.har \
...
if (!harPath) {
  console.error("Usage: node tooling/scripts/document-edit-runtime-har-gate.mjs <capture.har> [--max-total-requests=90]");
  process.exit(2);
}
