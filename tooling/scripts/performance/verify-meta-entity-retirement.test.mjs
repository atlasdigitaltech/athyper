...
const policy = json("governance/config/governance/release-gate.json");
...
const exceptions = json("governance/config/governance/meta-entity-performance-exceptions.json");
const current = { ...json("tooling/performance/qualification/current-report.example.json"), schemaVersion: 1 };
    ...
    evidence: {
      ...
      routes: {
        [route.id]: {
          ...
          qualificationArtifact: "tooling/performance/qualification/current-report.example.json",
