...
const budgetsPath = resolve(root, process.env.PERF_RECORD_WORKSPACE_BUDGETS || "tooling/performance/budgets/record-workspace.v1.json");
const outputDir = resolve(root, process.env.PERF_OUTPUT_DIR || "tooling/performance/artifacts/record-workspace");
