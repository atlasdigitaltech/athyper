...
//   tsx tooling/scripts/policy/verify-runtime-api-paths.ts          (warn mode, exit 0)
//   tsx tooling/scripts/policy/verify-runtime-api-paths.ts --strict (fail on any hit)
//
...
const ALLOW_FILES = new Set<string>([
  ...
  "tooling/scripts/policy/verify-runtime-api-paths.ts",
