...
const defaultReportPath = join(repoRoot, "governance", "policy", "reports", "shared-legacy-audit.json");
...
const defaultGroupReportPath = join(repoRoot, "governance", "policy", "reports", "shared-grouping-audit.json");
