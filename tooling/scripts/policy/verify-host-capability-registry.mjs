...
export function verifyHostCapabilityRegistry(paths = {}) {
  const registry = JSON.parse(readFileSync(paths.registry ?? resolve(root, "governance/config/deployment/host-capability-registry.json"), "utf8"));
  ...
  const profiles = JSON.parse(readFileSync(paths.profiles ?? resolve(root, "governance/config/deployment/profiles.json"), "utf8")).profiles;
