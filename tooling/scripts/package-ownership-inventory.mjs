...
const markdown = [
  ...
  "",
  "> Generated by `tooling/scripts/package-ownership-inventory.mjs`. Re-run after package moves or dependency changes.",
  "",
  ...
  "",
  "The Phase 0 frontend spine adds an explicit runtime/workspace dependency budget. The generated matrix and `governance/config/governance/frontend-spine-packages.json` must be updated together.",
  "",
