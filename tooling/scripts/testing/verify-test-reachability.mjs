...
const reportPath = resolve(
  root,
  "governance/policy/reports/test-reachability-retirement.json",
);
...
const ROOT_RUNNERS = [
  ...
  {
    directory: "tooling/scripts/policy",
    runner: "test:policy",
    commandFragment: "tooling/scripts/policy/",
  },
  {
    directory: "tooling/scripts/performance",
    runner: "test:performance-guards",
    commandFragment: "tooling/scripts/performance/",
  },
  {
    directory: "tooling/tools/scripts",
    runner: "test:tools",
    commandFragment: "tooling/tools/scripts/",
  },
  {
    directory: "tooling/scripts/verification",
    runner: "test:operations",
    commandFragment: "tooling/scripts/verification/",
  },
  {
    directory: "tooling/scripts/release",
    runner: "test:operations",
    commandFragment: "tooling/scripts/release/",
  },
  {
    directory: "tooling/scripts/rehearsal",
    runner: "test:operations",
    commandFragment: "tooling/scripts/rehearsal/",
  },
  {
    directory: "tooling/scripts/acceptance",
    runner: "test:operations",
    commandFragment: "tooling/scripts/acceptance/",
  },
  {
