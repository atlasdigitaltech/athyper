...
const semanticColorMap: Record<SemanticIntent, SemanticColorSet> = {
  // neutral = default/active state (things that exist and are functioning normally)
  neutral: {
    bg: "bg-muted",
  ...
  // muted = suppressed/tombstoned/archived state (things that no longer participate)
  muted: {
    bg: "bg-muted/60",
    ...
    subtleBadge: "bg-muted/40 text-muted-foreground/60 border-border/40",
  },
};
