...
export const REQUIRED_COLOR_TOKENS = [
  ...
  "border", "input", "primary", "primaryForeground", "primaryHover",
  "selectionStrong", "selectionStrongForeground", "selectionSubtle", "selectionSubtleForeground",
  "panelBackground", "panelHeaderBackground", "panelToolbarBackground", "danger", "dangerForeground",
  ...
  "storyWave", "storyWaveBright", "storyGlow", "storyDot", "storyBorder", "storySurface",
  "storySurfaceHover", "storySurfaceActive", "storySelectionBorder",
] as const;
...
export const COLOR_TOKENS: Readonly<Record<ColorMode, ColorTokenSet>> = Object.freeze({
  light: Object.freeze({
    ...
    primary: "var(--a-brand)", primaryForeground: "var(--a-brand-foreground)", primaryHover: "var(--a-brand-hover)",
    selectionStrong: "var(--a-primary)", selectionStrongForeground: "var(--a-primary-foreground)", selectionSubtle: "var(--a-brand-soft)", selectionSubtleForeground: "var(--a-primary)",
    panelBackground: "var(--a-surface)", panelHeaderBackground: "var(--a-surface)", panelToolbarBackground: "var(--a-muted)", danger: "#b42318", dangerForeground: "#ffffff",
    ...
    storyBorder: "color-mix(in srgb, var(--a-story-foreground) 14%, transparent)", storySurface: "color-mix(in srgb, var(--a-story-foreground) 6%, transparent)", storySurfaceHover: "color-mix(in srgb, var(--a-story-foreground) 10%, transparent)", storySurfaceActive: "color-mix(in srgb, var(--a-story-wave) 22%, transparent)", storySelectionBorder: "color-mix(in srgb, var(--a-story-wave-bright) 38%, transparent)",
  }),
  dark: Object.freeze({
    ...
    primary: "color-mix(in srgb, var(--a-brand) 32%, white)", primaryForeground: "color-mix(in srgb, var(--a-brand) 24%, black)", primaryHover: "var(--a-brand-hover)",
    selectionStrong: "var(--a-primary)", selectionStrongForeground: "var(--a-primary-foreground)", selectionSubtle: "var(--a-brand-soft)", selectionSubtleForeground: "var(--a-primary)",
    panelBackground: "var(--a-surface)", panelHeaderBackground: "var(--a-surface-raised)", panelToolbarBackground: "var(--a-muted)", danger: "#f97066", dangerForeground: "#230402",
    ...
    brand: ATLAS_MODERN_BRAND.colors.primary, brandForeground: ATLAS_MODERN_BRAND.colors.primaryForeground,
    brandHover: "color-mix(in srgb, var(--a-brand) 42%, white)", brandSoft: "color-mix(in srgb, var(--a-brand) 52%, black)",
    storyStart: ATLAS_MODERN_BRAND.colors.storyStart, storyEnd: ATLAS_MODERN_BRAND.colors.storyEnd,
    storyForeground: ATLAS_MODERN_BRAND.colors.storyForeground, storyMuted: ATLAS_MODERN_BRAND.colors.storyMuted, storyEyebrow: ATLAS_MODERN_BRAND.colors.storyEyebrow,
    storyWave: ATLAS_MODERN_BRAND.colors.storyWave, storyWaveBright: ATLAS_MODERN_BRAND.colors.storyWaveBright, storyGlow: ATLAS_MODERN_BRAND.colors.storyGlow, storyDot: ATLAS_MODERN_BRAND.colors.storyDot,
    storyBorder: "color-mix(in srgb, var(--a-story-foreground) 14%, transparent)", storySurface: "color-mix(in srgb, var(--a-story-foreground) 6%, transparent)", storySurfaceHover: "color-mix(in srgb, var(--a-story-foreground) 10%, transparent)", storySurfaceActive: "color-mix(in srgb, var(--a-story-wave) 22%, transparent)", storySelectionBorder: "color-mix(in srgb, var(--a-story-wave-bright) 38%, transparent)",
  ...
  "high-contrast": Object.freeze({
    ...
    primary: "#ffff00", primaryForeground: "#000000", primaryHover: "#ffffff",
    selectionStrong: "#ffff00", selectionStrongForeground: "#000000", selectionSubtle: "#000000", selectionSubtleForeground: "#ffff00",
    panelBackground: "#000000", panelHeaderBackground: "#000000", panelToolbarBackground: "#171717", danger: "#ff6b6b", dangerForeground: "#000000",
    ...
    storyBorder: "#ffffff", storySurface: "#000000", storySurfaceHover: "#171717", storySurfaceActive: "#000000", storySelectionBorder: "#ffff00",
  }),
});
