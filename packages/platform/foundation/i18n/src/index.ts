 ...
 *   import { i18nConfig, isRtlLocale } from "@athyper/platform-i18n/config";
 *   import { getIntl, loadModuleMessages } from "@athyper/platform-i18n/intl";
 *   import enCommon from "@athyper/platform-i18n/lang/en/common.json";
 *
 * Or from barrel:
 *   import { i18nConfig, getIntl } from "@athyper/platform-i18n";
 */
