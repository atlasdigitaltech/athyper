...
export function BellIcon(props: IconProps) {
  return (
    <IconFrame {...props}>
      ...
      <path d="M3.26 15.33A1 1 0 0 0 4 17h16a1 1 0 0 0 .74-1.67C19.41 13.85 18 12.18 18 8A6 6 0 0 0 6 8c0 4.18-1.41 5.85-2.74 7.33" />
    </IconFrame>
  );
}
...
export function ClipboardCheckIcon(props: IconProps) {
  return (
    <IconFrame {...props}>
      ...
      <path d="M9 3V2h6v1M9 12l2 2 4-4" />
    </IconFrame>
  );
}
...
export function InboxIcon(props: IconProps) {
  return (
    <IconFrame {...props}>
      ...
      <path d="m5.45 5.11-3.45 6.9V18a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-5.99l-3.45-6.9A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11Z" />
    </IconFrame>
  );
}
...
export function PanelsTopLeftIcon(props: IconProps) {
  return (
    <IconFrame {...props}>
...
export function ShoppingCartIcon(props: IconProps) {
  return (
    <IconFrame {...props}>
      ...
      <path d="M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h7.8a2 2 0 0 0 2-1.61L20.05 6H5.12" />
    </IconFrame>
  );
}
...
export function WarehouseIcon(props: IconProps) {
  return (
    <IconFrame {...props}>
      <path d="M18 21V10l-6-4-6 4v11" />
      <path d="m2 10 10-7 10 7M2 21h20M14 21v-7h4v7M6 14h4v4H6z" />
    </IconFrame>
  );
}
...
export function Minimize2Icon(props: IconProps) {
  return (
    <IconFrame {...props}>
      <path d="M4 4l6 6m0-6v6H4m16 10-6-6m0 6v-6h6" />
    </IconFrame>
  );
}
