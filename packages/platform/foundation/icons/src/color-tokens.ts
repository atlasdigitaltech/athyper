/**
 * @athyper/platform-icons — Color Token Registry
 *
...
function normalizeColorToken(colorToken: string | null | undefined): string {
 ...
 */
export function getEntityColorClasses(colorToken: string | null | undefined): EntityColorClasses {
  return COLOR_TOKEN_MAP[normalizeColorToken(colorToken)] ?? FALLBACK_COLORS;
}
