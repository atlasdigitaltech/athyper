/**
 * PageHeader â€” spec Â§1 Region 1 Â· unified across all four surface modes
 *
 * Layout (always two rows):
 *   Row 1: [â† back?] [type-chip?] [title] [status-slot?]   â†’  [actions]
 *   Row 2: [subtitle]                                            (absent when empty)
 *
 * The component is slot-based â€” callers compose identity and actions freely.
 ...
 *       subtitle="Step 1 of 3 Â· Identify"
 *       actions={<button onClick={onCancel}>Cancel</button>}
 *     />
 *
 * Spec Â§2 sizing:
 *   title (list)   â†’ text-xl / 600
 *   title (doc)    â†’ text-base / 600
 *   subtitle       â†’ text-xs / 400 / muted-foreground
 */
...
// â”€â”€ TypeChip â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
export function TypeChip({
  ...
  return (
    <span
      className={cn(
        "inline-flex h-8 shrink-0 items-center overflow-hidden rounded-md border border-border bg-foreground text-sm font-medium leading-none text-background",
        className,
      )}
    >
      {onBack && (
      ...
      <span className="flex h-full items-center px-3 text-xs leading-none">{children}</span>
    </span>
  );
}

// â”€â”€ ModeBadge â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
export interface PageHeaderProps {
  ...
  /**
   * "page" â†’ text-xl/600 (list pages, create "New").
   * "doc"  â†’ text-base/600 (detail/edit â€” document number is smaller than a page title).
   * Default: "page".
   */
  ...
  /** 12/400 muted-fg â€” subtitle shown on the second row (party name, step counter, etc.). */
  subtitle?: string;
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Primary actions â€” anchored in title row on mobile, hidden here on sm+ */}
        {primaryActions && (
          <div
            className={cn(
