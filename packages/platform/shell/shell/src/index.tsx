...
export function PlatformShell({localization=DEFAULT_LOCALIZATION,applicationName,tenantId,principalId,...props}: PlatformShellProps) { return <IntlProvider localization={localization} messages={shellMessages(localization.catalogLocale)} fallbackMessages={shellEnglishMessages}><ShellPersonalizationScopeProvider plane={applicationName} tenantId={tenantId} principalId={principalId}><ShellChrome currentLocale={localization.catalogLocale} applicationName={applicationName} tenantId={tenantId} {...props} /></ShellPersonalizationScopeProvider></IntlProvider>; }
