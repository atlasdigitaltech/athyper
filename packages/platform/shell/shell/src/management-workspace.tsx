...
export function ManagementNavigation({items,currentKey,label,onNavigate,moreLabel="More"}:{readonly items:readonly ManagementNavigationItem[];readonly currentKey?:string;readonly label:string;readonly onNavigate?:(href:string)=>void;readonly moreLabel?:string}) {
