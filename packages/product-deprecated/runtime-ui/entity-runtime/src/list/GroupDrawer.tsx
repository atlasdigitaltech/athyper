        ...
        <div className="flex items-center justify-between px-4 py-3 border-b shrink-0">
          <div className="flex items-center gap-2">
            ...
            {(draft !== null && draft !== undefined) && (
              <span className="inline-flex items-center justify-center h-4 min-w-4 px-1 rounded-full bg-primary text-primary-foreground text-xs font-medium">
                1
              </span>
            )}
          </div>
          ...
          {[2, 3].map((level) => (
            <div key={level} className="opacity-40">
              <div className="flex items-center justify-between mb-1">
                ...
                <span className="text-xs text-muted-foreground border rounded px-1.5 py-0.5">Coming in v2</span>
              </div>
              <div className="h-8 rounded-md border border-dashed border-muted-foreground/30 flex items-center justify-center text-xs text-muted-foreground">
