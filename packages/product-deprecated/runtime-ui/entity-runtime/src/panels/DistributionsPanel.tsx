    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-mediumr text-muted-foreground">
                ...
                {dists.map((d) => (
                  <tr key={d.id} className="hover:bg-muted/20 transition-colors">
                    ...
                    <td className="px-3 py-2">
                      <span className="inline-flex items-center h-4 px-1.5 rounded text-sm font-medium bg-muted border border-border/50 text-muted-foreground leading-none">
                    ...
                    <td className="px-3 py-2">
                      {d.account_code ? (
                        <span className="tabular-nums text-xs">{d.account_code}</span>
                      ) : (
