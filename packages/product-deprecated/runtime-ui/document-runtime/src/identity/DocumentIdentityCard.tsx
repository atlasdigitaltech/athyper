...
function TypeChip({
  ...
  const baseClass = cn(
    ...
    "text-background text-xs font-mediumr",
  ...
  return (
    <span
      className={cn(
        ...
        "text-xs font-medium leading-none border shrink-0",
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "text-xs font-mediumr leading-none whitespace-nowrap",
        "transition-opacity",
        variant === "destructive"
        ...
        <div className="flex items-center gap-3 flex-1 min-w-[200px]">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2 whitespace-nowrap">
              <span className="text-sm font-medium tabular-nums text-foreground leading-tight">
                {number}
              </span>
