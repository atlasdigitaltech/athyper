                  ...
                  return (
                    <section key={section.section_key} className="space-y-3 border-t border-border/50 pt-4 first:border-t-0 first:pt-0">
                      <div className="min-w-0">
                        <h3 className="text-sm font-medium text-foreground">{section.label ?? section.section_key}</h3>
                        {section.help_text && (
              ...
              <div className="flex items-center gap-2">
                ...
                {isLastStep ? (
                  ...
                  <button
                    ...
                    className={cn(
                      "flex items-center gap-1.5 rounded-md px-5 py-2 text-sm font-medium",
                      "bg-primary text-primary-foreground",
                      "hover:bg-primary/90 transition-colors disabled:cursor-not-allowed disabled:opacity-50",
                    )}
                  >
