...
function MoneyInput({
  ...
  return (
    <input
      ...
      min="0"
      className={cn(
        "w-full rounded-md border bg-background px-3 py-2 text-right text-lg font-medium tabular-nums",
...
function FieldLabel({
  ...
  return (
    <div className="flex items-baseline gap-1">
      ...
      {helpText && (
        <span className="text-xs text-muted-foreground/60 truncate" title={helpText}>
          {helpText}
        </span>
      )}
    </div>
