...
const permissions=new Set(["neon.relationship.business_partner_request.update","neon.relationship.business_partner_request.validate","neon.relationship.business_partner_request.submit","neon.relationship.business_partner_request.decide","neon.relationship.business_partner_request.apply"]);
