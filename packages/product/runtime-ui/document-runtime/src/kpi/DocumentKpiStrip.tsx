        ...
        return (
          ...
          >
            ...
            <div className="flex items-center justify-between gap-2 mb-1.5">
              <span className="text-xs font-mediumr text-muted-foreground leading-none truncate">
                {cell.label}
              </span>

              {cell.badge && (
                <span className={cn(
                  "inline-flex items-center h-[17px] px-[6px] rounded-[4px] text-xs font-medium border leading-none whitespace-nowrap shrink-0",
            ...
            {cell.xl ? (
              ...
              <div
                className="inline-flex items-center max-w-full rounded-[6px] bg-muted border border-border/60 px-2 py-[5px] tabular-nums text-sm font-medium text-foreground leading-none"
                title={cell.value}
              >
              ...
              <div
                className={cn(
                  "text-sm font-medium leading-tight tabular-nums truncate",
