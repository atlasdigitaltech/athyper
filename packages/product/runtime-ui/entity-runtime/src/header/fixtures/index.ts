 ...
 *
 * Seven canonical shapes that cover the full priority-row matrix.
...
export const viewMasterSimple: EntityHeaderModel = {
  identity: {
    typeLabel: "WAREHOUSE",
    typeHref: "/app/warehouse",
    number: "WH-CAI-TEGY",
    name: "Cairo Trading Warehouse",
    version: "v1",
    identifierAction: "copy",
    status: { label: "Active", intent: "success" },
  },
  actions: [
    { id: "edit", label: "Edit", placement: "primary", order: 1, icon: "pencil" },
    { id: "copy", label: "Copy", placement: "overflow", order: 2, group: "record" },
    { id: "delete", label: "Delete", placement: "danger", order: 3, group: "record" },
  ],
  tabs: [
...
export const FIXTURES: Record<string, EntityHeaderModel> = {
  ...
  "view-master-simple":            viewMasterSimple,
};
