  ...
  return (
    <div className="relative">
      <button
        ...
        disabled={busy}
        className="flex items-center gap-0.5 rounded px-1.5 py-0.5 text-xs text-muted-foreground hover:text-foreground hover:bg-muted/50 transition-colors disabled:opacity-40"
      >
        {busy
          ...
          return (
            <div key={status} className="min-w-[230px] max-w-[270px] flex-shrink-0 space-y-2">
              ...
              <div className={cn(
                ...
                <Badge
                  variant="secondary"
                  className="text-xs px-1.5 py-0.5 bg-background/50 border-0"
                  title={countTooltip}
                >
