      ...
      footerEnd={
        <>
          <button
            ...
            className="h-9 rounded-lg border border-border/60 px-4 text-xs font-semibold text-muted-foreground transition-colors hover:border-border hover:text-foreground"
          >
            Cancel
          </button>
          <button
            ...
            className="h-9 rounded-lg bg-foreground px-5 text-xs font-semibold text-background transition-opacity hover:opacity-85 disabled:opacity-40"
          >
