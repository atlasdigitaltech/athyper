                    ...
                    <td className="px-3 py-2.5 min-w-0">
                      {primaryText ? (
                        <>
                          ...
                          {subtitle && (
                            <div className="text-doc-support text-muted-foreground mt-0.5">{subtitle}</div>
                          )}
                        </>
                      ) : (
                    ...
                    {amountColumns.map((column) => (
                      <td
                        ...
                        className={cn(
                          ...
                          column.role === "net" ? "font-semibold text-primary" : "font-medium",
                        )}
                      >
        ...
        {amountColumns.map((column) => (
          <span key={column.key} className={column.role === "net" ? "ml-auto" : undefined}>
            ...
            <span className={cn(
              ...
              column.role === "net" && "font-bold text-primary",
            )}>
              {column.role === "deduction"
