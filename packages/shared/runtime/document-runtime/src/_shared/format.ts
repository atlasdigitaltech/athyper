/**
 * Shared formatting utilities — internal to document-runtime.
 *
 * Single source of truth for currency symbol resolution and number/amount
 * formatting. Replaces identical local implementations scattered across
 * AmountSummaryCard, DocumentKpiStrip, LineEditorSheet, SplitAccountingPanel,
 * LinesGrid, and ItemsGrid.
 */
