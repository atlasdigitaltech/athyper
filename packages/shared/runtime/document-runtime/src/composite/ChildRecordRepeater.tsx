    ...
    <div className="space-y-2">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          {optional && (
            <span className="text-2xs font-normal text-muted-foreground">(optional)</span>
          )}
          {rows.length > 0 && (
            <span className="inline-flex h-5 min-w-5 items-center justify-center rounded-full bg-primary/10 px-1.5 text-2xs font-semibold text-primary">
              {rows.length}
            </span>
          )}
          {isReadOnly && (
            <span className="text-2xs text-muted-foreground italic">read-only</span>
          )}
        </div>
          ...
          >
            ...
            >
              <div className="flex items-center gap-2 min-w-0">
                ...
                {hasError && (
                  <span className="shrink-0 text-2xs font-semibold text-destructive">
                    · incomplete
                  </span>
                )}
              </div>
