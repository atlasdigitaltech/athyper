    ...
    return (
      <div
        className={cn(
          ...
          "[&_h1]:text-base [&_h1]:font-semibold [&_h1]:text-foreground [&_h2]:text-sm [&_h2]:font-semibold [&_h2]:text-foreground [&_h3]:text-sm [&_h3]:font-medium [&_h3]:text-foreground",
          // Table — wrap in scroll container via CSS
          "[&_table]:min-w-full [&_table]:border-collapse [&_table]:text-xs",
          "[&_th]:border [&_th]:border-border [&_th]:bg-muted [&_th]:px-2 [&_th]:py-1 [&_th]:font-semibold [&_th]:text-left [&_th]:text-foreground",
