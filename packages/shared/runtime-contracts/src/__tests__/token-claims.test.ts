// packages/shared/runtime-contracts/src/__tests__/token-claims.test.ts
//
// Phase E unit tests — table-driven across valid and invalid token shapes.
...
describe("parseTokenClaims — happy path", () => {
...
// ─── Schema rejections — required fields ─────────────────────────────────────

describe("parseTokenClaims — required fields", () => {
...
// ─── Schema rejections — typed-optional fields ───────────────────────────────

describe("parseTokenClaims — typed optional fields", () => {
...
describe("parseTokenClaims — structured error", () => {
