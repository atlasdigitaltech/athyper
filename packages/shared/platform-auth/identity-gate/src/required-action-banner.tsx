...
// packages/shared/platform-auth/identity-gate/src/requiredActionBanner.tsx
//
// Phase A â€” Sticky banner for pending KC required-actions.
//
...
// happens implicitly â€” the host wires onComplete to its own router or to
...
export interface RequiredActionBannerProps {
  ...
  /** Optional dismiss action â€” when present, banner shows an X. */
  ...
  return (
    ...
    >
      ...
      {onDismiss && (
        ...
        >
          {/* simple Ã— character avoids depending on an icon set here */}
