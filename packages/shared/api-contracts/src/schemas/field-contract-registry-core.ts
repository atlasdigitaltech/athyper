...
export const ENTITY_CONTRACT_DEFINITIONS: PropertyContractDefinition[] = [
  {
    ...
    uiTab: "Layout",
    runtimeConsumers: [
      "packages/shared/runtime-list/src/core/listPresentation.ts",
      "packages/shared/runtime-canvas/src/index.tsx",
      "packages/shared/runtime-canvas/src/surfaces/surface-shell.tsx",
    ],
  },
  {
    ...
    uiTab: "Capabilities",
    runtimeConsumers: [
      "packages/shared/runtime-contracts/src/compiler.ts",
      "packages/shared/runtime-canvas/src/index.tsx",
  ...
  },
  {
    ...
    uiTab: "Search",
    runtimeConsumers: [
      "packages/shared/runtime-list/src/core/search.ts",
      "packages/shared/runtime-list/src/core/presenterProps.ts",
    ],
  },
];
...
export const ENTITY_FIELD_CONTRACT_DEFINITIONS: PropertyContractDefinition[] = [
  {
    ...
    uiTab: "Reference",
    runtimeConsumers: [
      "packages/shared/runtime-canvas/src/fields/registry.tsx",
      "packages/shared/runtime-canvas/src/edit/runtime-edit-form.tsx",
      "packages/shared/runtime-shared/src/entity-search/*.tsx",
      "apps/neon/app/api/runtime-options/[entity]/[field]/route.ts",
    ],
  },
  {
    ...
    runtimeConsumers: [
      "packages/shared/runtime-shared/src/core/format.ts",
  ...
  },
  {
    ...
    uiTab: "Filters",
    runtimeConsumers: [
      "packages/shared/runtime-list/src/core/columns.ts",
      "packages/shared/runtime-list/src/islands/organize/FilterControl.tsx",
    ],
  },
  {
    property: "ui_hint",
    ...
    runtimeConsumers: [
      "packages/shared/runtime-shared/src/meta-entity/field-visibility.ts",
      "packages/shared/runtime-canvas/src/surfaces/fields-surface.tsx",
    ],
  },
  {
    ...
    uiTab: "Edit Rules",
    runtimeConsumers: [
      "packages/shared/runtime-shared/src/meta-entity/field-editability.ts",
      "packages/shared/runtime-canvas/src/edit/runtime-descriptor-edit-workspace.tsx",
  ...
  },
  {
    ...
    runtimeConsumers: [
      "packages/shared/runtime-shared/src/entity-search/lookupConfig.ts",
    ],
  },
  {
    ...
    runtimeConsumers: [
      "packages/shared/runtime-shared/src/meta-entity/field-validation.ts",
      "packages/shared/runtime-canvas/src/edit/runtime-descriptor-edit-workspace.tsx",
      "packages/shared/runtime-shared/src/validation/metaFieldValidation.ts",
    ],
  },
  {
