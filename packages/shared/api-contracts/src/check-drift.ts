...
const WATCHED = [
  "packages/shared/api-contracts/src/schemas/common.ts",
  "packages/shared/api-contracts/src/schemas/metadata.ts",
  "packages/shared/api-contracts/src/schemas/records.ts",
  "packages/shared/api-contracts/src/schemas/documents.ts",
