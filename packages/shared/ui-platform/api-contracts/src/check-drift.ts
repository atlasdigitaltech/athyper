/**
 * @athyper/api-contracts â€” Contract Drift Checker
 *
...
const WATCHED = [
  ...
  "packages/shared/data-integration/api-contracts/src/schemas/ledger.ts",
  "packages/shared/data-integration/api-contracts/src/schemas/platform.ts",
  "packages/shared/data-integration/api-contracts/src/schemas/me.ts",
  "packages/shared/data-integration/api-contracts/src/schemas/iam.ts",
  "packages/shared/data-integration/api-contracts/src/schemas/entity-list.ts",
  "packages/shared/data-integration/api-contracts/src/enums.ts",
];
...
for (const file of WATCHED) {
  if (!(file in baseline)) {
    drifted.push(`${file} (new â€” not in baseline)`);
  }
}
...
console.log(`api-contracts: all ${WATCHED.length} schema files match baseline. âœ“`);
process.exit(0);
