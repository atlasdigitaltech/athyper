 ...
 *
 * The application Tailwind output is deliberately not used here. Keycloak
 * receives a small, deterministic utility subset plus framework-neutral IAM
 * component classes and the canonical token stylesheet.
 */
...
const tokensSource = path.join(packageRoot, "src/tokens/athyper.tokens.css");
const componentsSource = path.join(packageRoot, "src/iam-components.css");
...
async function main(): Promise<void> {
  ...
  const banner = [
    "/*",
    " * Generated by @athyper/theme/scripts/build-iam-css.ts.",
    " * DO NOT EDIT DIRECTLY — run: pnpm iam:build",
    " *",
  ...
  console.log(`IAM CSS built (${candidates.length} fixed utility candidates).`);
}
