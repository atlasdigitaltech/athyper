...
import { StagedAttachmentChip } from "../attachments/attachment-chip";
...
export function RichCommentComposer({
  ...
  return (
    <div className="rounded-lg border border-input bg-background text-foreground shadow-sm transition-[border-color,box-shadow] focus-within:border-ring focus-within:ring-2 focus-within:ring-ring/30">
      ...
      >
        <EditorContent
          ...
          className={cn(
            ...
            "[&_.ProseMirror_th]:border [&_.ProseMirror_th]:border-border [&_.ProseMirror_th]:bg-muted [&_.ProseMirror_th]:px-2 [&_.ProseMirror_th]:py-1 [&_.ProseMirror_th]:font-medium [&_.ProseMirror_th]:text-left [&_.ProseMirror_th]:text-foreground",
      ...
      {pasteNotice && (
        <div className="mx-3 mb-1 mt-2 flex items-center justify-between gap-2 rounded-md border border-border bg-muted/60 px-3 py-1.5 text-xs text-muted-foreground">
