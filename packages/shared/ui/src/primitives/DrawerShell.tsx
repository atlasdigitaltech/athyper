            ...
            {(badge || badgeDetail) && (
              <div className="shrink-0 flex flex-col items-center gap-1">
                {badge && (
                  <span
                    className={cn(
                      "inline-flex max-w-48 items-center truncate rounded-full border border-border bg-muted/40 px-2.5 py-1 text-sm font-medium leading-none text-muted-foreground",
                    )}
                  >
                    {badge}
                  </span>
