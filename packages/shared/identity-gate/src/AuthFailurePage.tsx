...
// packages/shared/identity-gate/src/AuthFailurePage.tsx
//
// Phase A — Full-page screen for fatal auth failures.
//
// Used by:
...
export interface AuthFailurePageProps {
  ...
  /** Correlation id (server requestId) — shown only when `showCorrelationId`. */
