...
import { useDocumentScrollSpy } from "../../object-page/useDocumentScrollSpy";
import {
...
import { installScrollStateControl, type ScrollStateControl } from "../utils/mockBrowser";
