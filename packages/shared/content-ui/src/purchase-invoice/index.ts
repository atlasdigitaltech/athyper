...
} from "./PaymentTermsCard";

// ─── Composer + projections (runtime-canvas registration targets) ──

export { buildPurchaseInvoiceHeaderProps } from "./PurchaseInvoiceConfig";
export {
  projectHeader,
  projectLine,
...
export { apInvoicePostingStrategy } from "../document-components/postings-preview/strategies/apInvoicePostingStrategy";
