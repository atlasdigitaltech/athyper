...
/**
 * Publishes the pinned RuntimeEntityHeader's height to a global CSS custom
 * property `--entity-header-offset` on `document.documentElement`.
 *
 ...
 *
 * Ported from `product/runtime-ui/entity-runtime/src/header/hooks/usePublishHeaderOffset.ts`
 * as part of the migration to runtime-canvas (June 2026).
 */
