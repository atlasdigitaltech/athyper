...
function TabButton({
  ...
  // Affordance shifts from "tab strip" to "section nav":
  //   - active treatment is a muted 1.5px underline + bolded label rather
  //     than the heavier solid bar that read as "switch view"
  //   - aria-label reads "Jump to {label}" so SR users get the right intent
  return (
    <button
      type="button"
      disabled={tab.disabled}
