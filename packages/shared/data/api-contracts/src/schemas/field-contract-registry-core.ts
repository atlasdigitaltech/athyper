...
export const ENTITY_CONTRACT_DEFINITIONS: PropertyContractDefinition[] = [
  {
    ...
    uiTab: "Layout",
    runtimeConsumers: [
      "packages/shared/runtime/entity-runtime/src/list/EntityListPage.tsx",
      "packages/shared/runtime/entity-runtime/src/detail/MasterDetailPage.tsx",
      "packages/shared/runtime/document-runtime/src/pages/DocumentDetailPage.tsx",
    ],
  },
  {
    ...
    uiTab: "Capabilities",
    runtimeConsumers: [
      "packages/shared/runtime/entity-runtime/src/metadata/compiled-reader.ts",
      "packages/shared/runtime/entity-runtime/src/detail/MasterDetailPage.tsx",
      "packages/shared/runtime/document-runtime/src/pages/DocumentDetailPage.tsx",
    ],
  },
  ...
  },
  {
    ...
    uiTab: "Identity",
    runtimeConsumers: [
      "server/framework/runtime/services/records/routes/records.route.ts",
      "packages/shared/runtime/entity-runtime/src/metadata/compiled-reader.ts",
    ],
  },
  {
...
export const ENTITY_FIELD_CONTRACT_DEFINITIONS: PropertyContractDefinition[] = [
  {
    ...
    uiTab: "Reference",
    runtimeConsumers: [
      "packages/shared/runtime/entity-runtime/src/field-renderers/register-defaults.tsx",
      "packages/shared/runtime/runtime-shared/src/entity-search/*.tsx",
      "packages/shared/runtime/document-runtime/src/items/*.tsx",
    ],
  },
  {
    ...
    runtimeConsumers: [
      "packages/shared/runtime/runtime-shared/src/core/format.ts",
  ...
  },
  {
    ...
    uiDescription: "Controls filter drawer section, control type, quick filter behavior, and labels.",
    uiTab: "Filters",
    runtimeConsumers: [
      "packages/shared/runtime/entity-runtime/src/list/FilterDrawer.tsx",
    ],
  },
  {
    property: "ui_hint",
  ...
  },
  {
    ...
    uiTab: "Edit Rules",
    runtimeConsumers: [
      "packages/shared/runtime/entity-runtime/src/edit",
      "packages/shared/runtime/document-runtime/src/pages/DocumentDetailPage.tsx",
    ],
  },
  {
    ...
    runtimeConsumers: [
      "packages/shared/runtime/runtime-shared/src/entity-search/lookupConfig.ts",
    ],
  },
  {
    ...
    runtimeConsumers: [
      "packages/shared/runtime/entity-runtime/src/edit/buildDescriptorFromCompiledEntity.ts",
      "packages/shared/runtime/runtime-shared/src/validation/metaFieldValidation.ts",
    ],
  },
  {
    ...
    uiTab: "Basics",
    runtimeConsumers: [
      "packages/shared/runtime/document-runtime/src/items/metaLineRuntime.tsx",
    ],
  },
  {
