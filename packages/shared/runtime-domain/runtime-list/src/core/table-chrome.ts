...
export const runtimeTableChrome = {
  ...
  shell:          "min-h-0 w-full min-w-0 overflow-visible rounded-md border bg-background",
  ...
  footerAttached: "sticky left-0 mt-2 w-[100cqw] rounded-md border bg-background shadow-sm md:bottom-0 md:z-30 md:-mt-px md:rounded-t-none md:bg-background/95 md:backdrop-blur",
  footerDetached: "relative mt-2 w-full rounded-md border bg-background shadow-sm",
