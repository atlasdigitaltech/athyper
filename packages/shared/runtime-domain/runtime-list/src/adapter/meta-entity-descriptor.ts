...
// Converts the shared MetaEntityRuntimeDescriptor contract to the list
// runtime's plane-neutral RuntimeDescriptor. This is the only implementation
// of this conversion; plane packages may re-export it for compatibility.
