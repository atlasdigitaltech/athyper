...
import { installInertIntersectionObserver } from "./utils/mock-observers";
import { installInertResizeObserver } from "./utils/mock-observers";
import { installMatchMediaMock } from "./utils/mock-browser";
import { installScrollIntoViewMock } from "./utils/mock-browser";
import { installRequestAnimationFrameMock } from "./utils/mock-browser";
