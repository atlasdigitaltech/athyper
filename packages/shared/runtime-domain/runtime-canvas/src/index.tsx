...
export { toEntityEditState } from "./record/document-edit-draft-adapter";
export {
          ...
          <div className="hidden sm:grid sm:grid-cols-[auto_minmax(0,1fr)] sm:items-center sm:gap-4">
            ...
            <div className="flex items-center gap-4">
              <div className="flex flex-1 items-center gap-3">
                ...
                <span className="inline-flex shrink-0 items-center rounded-sm border border-border bg-muted px-2.5 py-1 text-[11px] font-semibold uppercase leading-none tracking-wide text-muted-foreground">
                  New
                </span>
              </div>
