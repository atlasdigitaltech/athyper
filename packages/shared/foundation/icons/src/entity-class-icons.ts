/**
 * @athyper/icons — Entity Class Icon Registry
 *
 ...
 */
export function getEntityClassIcon(entityClass: string): LucideIcon {
  return ENTITY_CLASS_ICON_MAP[entityClass] ?? FALLBACK_ICON;
}
