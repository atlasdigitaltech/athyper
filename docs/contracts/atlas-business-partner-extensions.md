...
Release scope decision, 2026-09-10: duplicate candidates, document expiry and
optional draft preview are deferred from the current BP-AI-00–08 completion
candidate under the authorized "complete or explicitly defer" option. This
document is their separate backlog and preserves every owner and qualification
gate below. The deferral does not mark those capabilities implemented or enabled.
