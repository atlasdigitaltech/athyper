...
```text
common/control/02_domains.sql
common/event/02_domains.sql
common/control/03_tables.sql
common/event/03_tables.sql
common/control/05_constraints.sql
common/event/05_constraints.sql
common/control/06_indexes.sql
common/event/06_indexes.sql
common/event/07_notification_runtime_functions.sql
common/control/08_triggers.sql
common/event/08_triggers.sql
common/control/10_rls.sql
common/event/10_rls.sql
common/control/11_grants.sql
common/event/11_grants.sql
```
