...
- `decisions/business-partner-phase-0.md` — accepted authority, external applicant, workflow UI, protected-document, notification and release-status baseline.
...
- `business-partner/README.md` — canonical capability baseline and Phase 0 evidence map for Business Partner organizations, Supplier and Customer roles, and supplier-provided Workforce journeys.
