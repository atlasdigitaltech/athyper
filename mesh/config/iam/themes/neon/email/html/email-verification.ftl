<#-- ============================================================
     Athyper Neon Email Theme — email-verification.ftl (HTML)
     Triggered by: Verify Email required action
...
<head>
  ...
  <![endif]-->
  <title>Verify your email — Athyper</title>
</head>
            ...
            <td style="background-color:#1c1c1c;border-radius:8px 8px 0 0;padding:28px 40px;">
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                <tr>
                  ...
                  <td align="right">
                    <span style="font-size:11px;color:rgba(255,255,255,0.55);letter-spacing:0.06em;text-transform:uppercase;">Email Verification</span>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="padding:24px 40px 32px;">
              ...
              <p style="margin:0 0 28px;font-size:14px;color:#6b6b6b;line-height:1.7;text-align:center;">
                Hi <strong>${user.firstName!""} ${user.lastName!""}</strong>, welcome to Athyper!<br/>
                To complete your account setup, please verify that
                <a href="mailto:${user.email}" style="color:#555555;text-decoration:none;">${user.email}</a>
                belongs to you.
              </p>
                ...
                <tr>
                  <td align="center" style="padding-bottom:28px;">
                    ...
                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word"
                      ...
                      <w:anchorlock/>
                      <center style="color:#ffffff;font-family:sans-serif;font-size:14px;font-weight:600;">Verify email address</center>
                    </v:roundrect>
                    <![endif]-->
                    <!--[if !mso]><!-->
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-top:24px;">
                <tr>
                  <td style="padding:20px;background-color:#fafafa;border-radius:6px;border:1px solid #f0f0f0;">
                    <p style="margin:0 0 10px;font-size:13px;font-weight:600;color:#333333;">What happens next?</p>
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                      <tr>
          ...
          <tr>
            <td style="border-top:1px solid #f0f0f0;padding:20px 40px;">
              <p style="margin:0;font-size:12px;color:#9b9b9b;line-height:1.7;">
                <strong style="color:#6b6b6b;">Didn't create an Athyper account?</strong><br/>
