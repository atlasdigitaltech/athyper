...
REM   relative volume paths (like ../../config, ../../data) from each
REM   file's own directory — NOT from the project root.  This matches
REM   how up.sh works and ensures MESH_CONFIG / MESH_DATA resolve to
REM   mesh/config and mesh/data (not the root-level config/data dirs).
REM ----------------------------
set "COMPOSE_FILES="
