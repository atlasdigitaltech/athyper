...
DBPOOL_APPS_PASSWORD=$(openssl rand -hex 32)
DBPOOL_SESSION_PASSWORD=$(openssl rand -hex 32)
ENTITY_QUERY_CURSOR_SECRET=$(openssl rand -hex 32)
SESSION_TOKEN_ENCRYPTION_KEY=$(openssl rand -base64 32 | tr -d '\n')
IAM_ADMIN_PASSWORD=$(openssl rand -base64 32 | tr -d '\n=')
IAM_CLIENT_SECRET=$(openssl rand -hex 32)
STUDIO_WEB_CLIENT_SECRET=$(openssl rand -hex 32)
...
REDIS_BULLBOARD_PASSWORD=$(openssl rand -base64 32 | tr -d '\n=')
BULLBOARD_UI_USER=athyper-emergency
BULLBOARD_UI_PASSWORD=$(openssl rand -base64 32 | tr -d '\n=')
...
ENTITY_QUERY_CURSOR_SECRET=$ENTITY_QUERY_CURSOR_SECRET
SESSION_TOKEN_ENCRYPTION_KEY=$SESSION_TOKEN_ENCRYPTION_KEY
IAM_ADMIN_PASSWORD=$IAM_ADMIN_PASSWORD
IAM_CLIENT_SECRET=$IAM_CLIENT_SECRET
STUDIO_WEB_CLIENT_SECRET=$STUDIO_WEB_CLIENT_SECRET
...
BULLBOARD_UI_USER=$BULLBOARD_UI_USER
BULLBOARD_UI_PASSWORD=$BULLBOARD_UI_PASSWORD
...
DBPOOL_SESSION_PASSWORD=$DBPOOL_SESSION_PASSWORD
DATABASE_URL=postgresql://athyper_user:$DBPOOL_APPS_PASSWORD@dbpool-apps:6432/athyper_neon
DATABASE_ADMIN_URL=postgresql://postgres:$DB_ADMIN_PASSWORD@athyper-db-1:5432/athyper_neon
ATHYPER_PLATFORM_DATABASE_URL=postgresql://athyper_user:$DBPOOL_APPS_PASSWORD@dbpool-apps:6432/athyper_studio
MESH_DATABASE_URL=postgresql://athyper_user:$DBPOOL_APPS_PASSWORD@dbpool-apps:6432/athyper_mesh
ENTITY_QUERY_CURSOR_SECRET=$ENTITY_QUERY_CURSOR_SECRET
SESSION_TOKEN_ENCRYPTION_KEY=$SESSION_TOKEN_ENCRYPTION_KEY
