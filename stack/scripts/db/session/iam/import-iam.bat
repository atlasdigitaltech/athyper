...
for %%V in (KC_SMTP_HOST KC_SMTP_PORT KC_SMTP_FROM KC_SMTP_FROM_DISPLAY_NAME KC_SMTP_AUTH KC_SMTP_SSL KC_SMTP_STARTTLS KC_SMTP_USERNAME KC_SMTP_PASSWORD KC_WEBAUTHN_RP_ID STUDIO_WEB_CLIENT_SECRET ATHYPER_SVC_RUNTIME_WORKER_CLIENT_SECRET NEON_SVC_BFF_CLIENT_SECRET GITHUB_OAUTH_CLIENT_ID GITHUB_OAUTH_CLIENT_SECRET GOOGLE_CLIENT_ID GOOGLE_CLIENT_SECRET MICROSOFT_CLIENT_ID MICROSOFT_CLIENT_SECRET LINKEDIN_CLIENT_ID LINKEDIN_CLIENT_SECRET ATHYPER_ENTERPRISE_WINDOWS_AUTH_ENABLED APPS_ATHYPER_NEON_HOST APPS_ATHYPER_MESH_HOST APPS_ATHYPER_STUDIO_HOST) do (
    if not defined %%V (
        if defined ENV_FILE_IMP (
...
if not defined APPS_ATHYPER_STUDIO_HOST set "APPS_ATHYPER_STUDIO_HOST=studio.athyper.local"
set "NEON_PUBLIC_WEB_URL=https://!APPS_ATHYPER_NEON_HOST!"
set "MESH_PUBLIC_WEB_URL=https://!APPS_ATHYPER_MESH_HOST!"
set "STUDIO_PUBLIC_WEB_URL=https://!APPS_ATHYPER_STUDIO_HOST!"
...
docker run --rm ^
  ...
  -e STUDIO_PUBLIC_WEB_URL=!STUDIO_PUBLIC_WEB_URL! ^
  -e STUDIO_WEB_CLIENT_SECRET=!STUDIO_WEB_CLIENT_SECRET! ^
