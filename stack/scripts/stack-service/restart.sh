#!/usr/bin/env bash
# ============================================================
# athyper Stack - CONTAINER RESTART - Linux/macOS
# Location: stack/scripts/stack-service/restart.sh
# Usage:
#   ./restart.sh iam                 -> restart by alias
#   ./restart.sh db redis            -> restart multiple at once
#   ./restart.sh --time 30 gateway   -> graceful stop timeout (seconds)
#   ./restart.sh -t 30 gateway       -> same as above
#
