...
REM ============================================================
REM athyper Stack - CONTAINER STOP - Windows Batch
REM Location: stack\scripts\stack-service\stop.bat
REM Usage:
REM   stop.bat iam                   -> stop by alias
...
echo Stopping: !CNAME!
docker stop !TIME_ARG! "!CNAME!"
if errorlevel 1 echo WARNING: docker stop returned non-zero for !CNAME!
