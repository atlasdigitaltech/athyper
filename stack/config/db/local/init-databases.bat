...
REM   athyper_studio, athyper_neon, athyper_mesh, athyper_iam,
...
for %%D in (athyper_studio athyper_mesh athyper_iam athyper_health athyper_errors athyper_secrets athyper_analytics) do (
    set "DB_EXISTS="
