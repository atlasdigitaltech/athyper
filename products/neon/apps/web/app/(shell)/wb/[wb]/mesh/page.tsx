...
import { ArrowRight, GitBranch, ListTodo, Shapes, Shield } from "lucide-react";
      ...
      <section className="relative overflow-hidden rounded-xl border bg-gradient-to-br from-muted/50 via-background to-muted/30 px-6 py-8">
        ...
        <div className="relative">
          ...
          <p className="mt-1 max-w-lg text-sm text-muted-foreground leading-relaxed">
            Design schemas, lifecycles, and access policies — then monitor the
            jobs that keep it all running.
          </p>
        </div>
      </section>
                ...
                >
                  <CardContent className="flex flex-col gap-4 p-5">
                    ...
                    <div className="flex items-start justify-between">
                      ...
                      >
                        <app.icon className={`size-5 ${app.accent}`} />
                      </div>
