...
export function FlagCommentModal({
  ...
  const flagReasons: Array<{
    ...
    },
    {
      value: "harassment",
      label: "Harassment",
      description: "Harassing, threatening, or bullying behavior",
    },
    {
    ...
    },
    {
      value: "other",
      label: "Other",
      description: "Other policy violation (please provide details)",
    },
  ];
        ...
        {success ? (
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="p-6 space-y-4">
              <p className="text-sm text-gray-600">
                Please select the reason for flagging this comment. Our
