...
export default function UserLoginPage() {
    ...
    const returnUrl = searchParams.get("returnUrl") ?? "/wb/user/home";

    function handleLogin() {
        const params = new URLSearchParams({ workbench: "user", returnUrl });
        ...
        <div className="flex min-h-dvh">
            ...
            >
                <div className="space-y-6 text-center p-12">
                    <User className="mx-auto size-12" style={{ color: "#fff" }} />
            ...
            <div className="flex w-full items-center justify-center bg-background p-8 lg:w-2/3">
                <div className="w-full max-w-sm space-y-8">
                    <div className="space-y-2 text-center">
                        ...
                        <h2 className="text-2xl font-medium tracking-tight">User Sign In</h2>
                        <p className="text-sm text-muted-foreground">
                            Sign in to access the user workbench.
                        </p>
                    </div>
                    ...
                    <div className="space-y-3">
                        <button
                            ...
                            onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = BRAND.bgHover)}
