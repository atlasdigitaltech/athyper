...
export function FieldRenderer({ field, value, viewMode, resolvedRef, readOnlyReason, onChange }: FieldRendererProps) {
    ...
    if (viewMode === "view") {
        return (
            <ViewField label={displayLabel} field={field} value={value} />
        );
    }
