...
import { groupFieldsIntoSections, getFieldEditBehavior } from "@/lib/entity-page/section-grouping";
...
export function EntityForm({
    ...
    for (const field of fieldMeta) {
        ...
        defaultValues[field.columnName] = existing ?? (field.dataType === "boolean" ? false : "");
    }
                    ...
                    <Card key={section.code} className="p-4">
                        ...
                        <div className={`grid ${gridCols} gap-4`}>
                            {section.fields.map((fieldName) => {
                                ...
                                const effectiveViewMode = editBehavior.readOnly ? "view" : vmForField;
                                ...
                                return (
                                    <FieldRenderer
                                        ...
                                        readOnlyReason={editBehavior.readOnly ? editBehavior.reason : undefined}
