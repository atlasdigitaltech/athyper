...
interface ConditionGroup {
  operator?: "and" | "or";
  conditions: Array<
    { field: string; operator: string; value: unknown } | ConditionGroup
  >;
}
...
export function TransitionGateEditor({
  edge,
  open,
  onOpenChange,
  onSave,
}: TransitionGateEditorProps) {
  const gateData = (edge?.data as Record<string, unknown> | undefined)?.gate as
    | TransitionGateData
    | undefined;
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex items-center gap-2">
              ...
              <Input
                ...
                value={slaMinutes}
                onChange={(e) =>
                  setSlaMinutes(parseInt(e.target.value, 10) || 0)
                }
                className="w-20 text-xs"
              />
          ...
          <div className="space-y-1.5">
            ...
            <ConditionTreeBuilder
              ...
              onChange={(g) =>
                setConditions(g.conditions.length === 0 ? null : g)
              }
              fields={GATE_FIELDS}
              maxDepth={2}
            />
