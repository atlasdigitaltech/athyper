...
export const ABAC_FIELD_CATEGORIES = {
  Subject: [
    {
      path: "subject.principalId",
      label: "Principal ID",
      hint: "User or service account ID",
    },
    {
      path: "subject.principalType",
    ...
    { path: "subject.roles", label: "Roles", hint: "Array of assigned roles" },
    {
      path: "subject.groups",
      label: "Groups",
      hint: "Array of group memberships",
    },
    {
      path: "subject.attributes.department",
      label: "Department",
      hint: "Organization department",
    },
    {
      path: "subject.attributes.level",
      label: "Level",
      hint: "Job level / seniority",
    },
    {
      path: "subject.attributes.costCenter",
      label: "Cost Center",
      hint: "Subject cost center",
    },
    {
      path: "subject.ouMembership.path",
      label: "OU Path",
      hint: "Org unit path (e.g. /org/div1/)",
    },
    {
      path: "subject.ouMembership.code",
      label: "OU Code",
      hint: "Org unit code",
    },
  ],
  Resource: [
    ...
    { path: "resource.module", label: "Module", hint: "Owning module code" },
    {
      ...
      label: "Owner ID",
      hint: "Record owner principal ID",
    },
    {
      path: "resource.costCenter",
      label: "Cost Center",
      hint: "Resource cost center",
    },
    {
      path: "resource.attributes.status",
      label: "Status",
      hint: "Record lifecycle status",
    },
    {
      path: "resource.attributes.classification",
      label: "Classification",
      hint: "Data classification level",
    },
  ],
  Context: [
    ...
    { path: "context.ipAddress", label: "IP Address", hint: "Client IP" },
    {
      ...
      label: "User Agent",
      hint: "Client browser/device",
    },
    {
      path: "context.channel",
      label: "Channel",
      hint: "Access channel (web, api, mobile)",
    },
    {
      path: "context.deviceType",
      label: "Device Type",
      hint: "desktop | mobile | tablet",
    },
    ...
    { path: "context.geo.region", label: "Region", hint: "Geographic region" },
    {
      ...
      label: "Hour (UTC)",
      hint: "Current hour 0-23",
    },
    {
      path: "context.time.dayOfWeek",
      label: "Day of Week",
      hint: "0=Sun, 6=Sat",
    },
  ],
  Action: [
    {
      path: "action.namespace",
      label: "Namespace",
      hint: "Action namespace (e.g. entity)",
    },
    { path: "action.code", label: "Code", hint: "Action code (e.g. update)" },
    {
      path: "action.fullCode",
      label: "Full Code",
      hint: "namespace:code (e.g. entity:update)",
    },
  ],
} as const;
...
export function PolicyConditionBuilder({
  ...
  const handleVisualChange = useCallback(
    (updated: ConditionGroup) => {
      ...
      setJsonText(
        updated.conditions.length === 0 ? "" : JSON.stringify(updated, null, 2),
      );
      setJsonError(null);
    },
    [onChange],
    ...
    <div className="space-y-2">
      ...
      {!value && mode === "visual" && (
        <p className="text-xs text-muted-foreground">
          No conditions — rule applies to all matching subjects. Click "Add
          Condition" above to add ABAC conditions.
        </p>
      )}
    </div>
  );
