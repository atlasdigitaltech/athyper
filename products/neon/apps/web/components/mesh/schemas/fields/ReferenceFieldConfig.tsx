...
const ON_DELETE_OPTIONS = [
  {
    value: "restrict",
    label: "Restrict",
    description: "Prevent deletion if referenced",
  },
  {
    value: "cascade",
    label: "Cascade",
    description: "Delete referencing records too",
  },
  {
    value: "set_null",
    label: "Set Null",
    description: "Nullify the reference on deletion",
  },
] as const;
    ...
    <div className="space-y-3 rounded-md border bg-muted/30 p-3">
      ...
      <div className="space-y-1.5">
        ...
        <Select
          ...
          onValueChange={(v) =>
            onChange({ ...value, onDelete: v as LookupConfig["onDelete"] })
          }
        >
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        ...
        >
          <span
            className={
              value ? "font-mono text-xs" : "text-muted-foreground text-xs"
            }
          >
            {value || "Select entity..."}
          </span>
