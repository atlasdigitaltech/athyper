    ...
    return (
        <div className="space-y-4">
            ...
            <SectionCard
                ...
                description={t("tenant.profile.currentUserRolesDesc", "Realm roles assigned to the current session.")}
            >
                {data.roles.length > 0 ? (
            ...
            <SectionCard
                ...
                description={t("tenant.profile.clientRolesDesc", "Application-specific roles from Keycloak resource_access.")}
            >
            ...
            <SectionCard
                ...
                description={t("tenant.profile.groupsDesc", "Group membership for data scoping.")}
            >
            ...
            {/* Org-wide Membership */}
            <SectionCard title={t("tenant.profile.orgMembership", "Organization Membership")}>
