  ...
  return (
    <div className="space-y-4">
      ...
      <SectionCard
        ...
        description={t(
          "tenant.profile.emailDomainsDesc",
      ...
      <p className="text-center text-sm text-muted-foreground">
        {t(
          "tenant.profile.domainsSsoComingSoon",
          "Domain and SSO configuration requires BFF integration. Coming soon.",
        )}
      </p>
    </div>
  );
