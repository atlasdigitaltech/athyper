...
export function IamSecurityTab({ data }: IamSecurityTabProps) {
  ...
  return (
    <div className="space-y-4">
        ...
        <FieldRow
          ...
          value={
            <Badge variant="default" className="text-xs">
              {t("tenant.profile.enabled", "Enabled")}
            </Badge>
          }
        />
      </SectionCard>
      ...
      {/* Session Settings */}
      <SectionCard
        title={t("tenant.profile.sessionSettings", "Session Settings")}
      >
        <FieldRow
      ...
      {/* Security Policies */}
      <SectionCard
        title={t("tenant.profile.securityPolicies", "Security Policies")}
      >
        <FieldRow
