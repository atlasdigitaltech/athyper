...
const TABS_CONFIG: TabConfig[] = [
  {
    id: "overview",
    i18nKey: "tenant.profile.tab.overview",
    fallback: "Overview",
  },
  {
    id: "identity",
    i18nKey: "tenant.profile.tab.identity",
    fallback: "Identity & Branding",
  },
  { id: "iam", i18nKey: "tenant.profile.tab.iam", fallback: "IAM & Security" },
  {
    id: "users",
    i18nKey: "tenant.profile.tab.users",
    fallback: "Users & Roles",
  },
  {
    id: "domains",
    i18nKey: "tenant.profile.tab.domains",
    fallback: "Domains & SSO",
  },
  {
    id: "modules",
    i18nKey: "tenant.profile.tab.modules",
    fallback: "Modules & Limits",
  },
];
