...
export function TenantManagementSection({ model, workbench }: SectionProps) {
  ...
  const hasAnyItem =
    v.tenantProfile || v.legalProfile || v.subscription || v.diagnostics;
  ...
  return (
    <>
      ...
      <DropdownMenuGroup>
        {v.tenantProfile && (
          <DropdownMenuItem
            onClick={() => router.push(`/wb/${workbench}/settings/tenant`)}
          >
        ...
        {v.legalProfile && (
          <DropdownMenuItem
            onClick={() => router.push(`/wb/${workbench}/settings/company`)}
          >
        ...
        {v.subscription && (
          <DropdownMenuItem
            onClick={() =>
              router.push(`/wb/${workbench}/settings/subscription`)
            }
          >
...
export function OperationalSection({ model, workbench }: SectionProps) {
  ...
  return (
    <>
      ...
      <DropdownMenuGroup>
        <DropdownMenuItem
          onClick={() => router.push(`/wb/${workbench}/settings`)}
        >
        ...
        {v.savedSuppliers && (
          <DropdownMenuItem
            onClick={() => router.push(`/wb/${workbench}/suppliers/saved`)}
          >
        ...
        <DropdownMenuItem
          onClick={() => router.push(`/wb/${workbench}/support`)}
        >
          ...
          {THEME_PRESET_OPTIONS.map((preset) => {
            ...
            return (
              <DropdownMenuItem
                key={preset.value}
                onClick={() =>
                  model.handlePresetChange(preset.value as ThemePreset)
                }
              >
