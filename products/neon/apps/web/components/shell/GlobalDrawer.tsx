        ...
        <div className="border-t p-3">
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    <button className="flex w-full items-center gap-2.5 rounded-md p-2 text-left transition-colors hover:bg-accent">
                        ...
                        <div className="min-w-0 flex-1">
                            <p className="truncate text-sm font-semibold">{model.truncatedName}</p>
                ...
                <DropdownMenuContent side="top" align="start" className="w-64">
                    ...
                    <TenantManagementSection model={model} workbench={workbench} variant="drawer" />
                    <OperationalSection model={model} workbench={workbench} variant="drawer" />
