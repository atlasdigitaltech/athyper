            ...
            {lines.map((line, idx) => (
              ...
              >
                ...
                <td className="px-3 py-2">
                  {isEdit ? (
                    <Input
                      ...
                      onChange={(e) =>
                        onLineChange?.(idx, "accountId", e.target.value)
                      }
                ...
                <td className="px-3 py-2">
                  {isEdit ? (
                    <Input
                      ...
                      onChange={(e) =>
                        onLineChange?.(idx, "description", e.target.value)
                      }
                      className="h-8 text-sm"
                    />
                  ) : (
                ...
                <td className={cn("px-3 py-2", amountCellClass)}>
                  {isEdit ? (
                    <Input
                      ...
                      onChange={(e) =>
                        onLineChange?.(idx, "debitAmount", e.target.value)
                      }
                ...
                <td className={cn("px-3 py-2", amountCellClass)}>
                  {isEdit ? (
                    <Input
                      ...
                      onChange={(e) =>
                        onLineChange?.(idx, "creditAmount", e.target.value)
                      }
                      className="h-8 text-sm text-right font-mono tabular-nums"
                    />
                  ) : (
                ...
                <td className="px-3 py-2 text-muted-foreground text-xs">
                  {line.subledgerType
                    ? `${line.subledgerType}: ${line.subledgerRefId ?? ""}`
                    : "\u2014"}
                </td>
