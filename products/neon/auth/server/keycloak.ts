...
// products/neon/auth/server/keycloak.ts
//
...
// ─── Keycloak Userinfo ──────────────────────────────────────────
//
// Fetches the canonical identity from Keycloak's userinfo endpoint.
// Used by diagnostics actions (sync-profile, session/rebuild) to
