...
export interface Container {
  readonly adapters: {
    ...
    authorizationWriterDatabases?: Partial<
      Record<"studio" | "neon" | "mesh", Kysely<Record<string, never>>>
    >;
    ...
    objectStorageArtifacts?: S3ObjectStorageAdapter;
    objectStorageArtifactsBucket?: string;
    objectStorageTransfers?: S3ObjectStorageAdapter;
    objectStorageTransfersBucket?: string;
  ...
  readonly platform: {
    ...
    trustIam?: {
      ...
      >;
      readonly projections: OrganizationProjectionService<
        Transaction<Record<string, never>>
      >;
      readonly scopes: ProjectionScopeService<
        Transaction<Record<string, never>>
      >;
      readonly identityProvisioning: IdentityProvisioningService<
        Transaction<Record<string, never>>
      >;
    };
    ...
    governance?: {
      ...
      readonly cycleConfig: CycleConfigReader;
    ...
    controlAdmin?: {
      readonly cycleConfig?: CycleConfigService;
      readonly services?: ControlServices;
      readonly runtimeCommands?: RuntimeCommandService;
      readonly authorizationManagement?: AuthorizationManagementService;
      readonly routeFlags: ControlServiceRouteFlags;
      readonly routesEnabled: boolean;
    };
    ai?: {
      readonly ledger: AtlasToolProposalStore;
      readonly threads?: AtlasThreadService;
      readonly runtime?: AtlasAgentRuntime;
      readonly tools?: AtlasToolService;
      readonly operations?: AtlasA2Services;
      readonly routesEnabled: boolean;
      readonly toolsEnabled: boolean;
    };
    search?: DocumentSearchService;
    experience?: {
      readonly service: ReturnType<typeof createExperienceService>;
      readonly invalidation: ReturnType<
        typeof createExperienceInvalidationHooks
      >;
    };
  ...
  readonly services: {
    ...
    records?: {
      ...
      readonly surfaces?: Pick<
        import("@athyper/server-service-records").EntityListService,
        "list" | "record" | "applicationDescriptor"
      >;
    ...
    finance?: {
      ...
      readonly slices?: NeonFinanceRegistration["slices"];
    };
