...
export function registerAtlas(
  ...
  const runtime = new AtlasAgentRuntime({ admission: dependencies.admission, modelPolicy: dependencies.modelPolicy, bindings, providers, credentials: operations.resolver, threads, runs: dependencies.runs, ledger: dependencies.usageLedger, prompts: dependencies.prompts, quota:quotas, experience, ...(coordinator ? { tools: coordinator } : {}), maxInputCharacters: 50_000, maxToolRounds: toolsEnabled ? 3 : 0 });
