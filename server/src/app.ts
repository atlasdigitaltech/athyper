...
import { initOtel, getOtelShutdown } from "./foundation/monitoring/otel.js";
...
import { initSentry } from "./foundation/monitoring/sentry.js";
...
void bootstrap(config, kernelConfig)
  ...
  .catch((err: unknown) => {
    ...
    void import("./foundation/monitoring/sentry.js").then(({ Sentry }) => {
