// server/src/audit.ts
//
// Audit event types and writers.
//
// Currently used for boot/shutdown lifecycle events.
// Route handlers use createRouteAuditEntry() to write entity mutation records
// directly to log.audit_log via Kysely.
//
// Writers:
//   createConsoleAuditWriter()  — dev default, logs to stdout
//   createNoopAuditWriter()     — for tests
//   createDbAuditWriter(db)     — inserts into log.audit_log (staging/production)
