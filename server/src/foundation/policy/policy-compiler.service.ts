...
import { PolicyEngine, type EvaluateParams, type EvaluateResult, type PolicyAction } from "../../../framework/runtime/services/policy/engine.js";
...
export class PolicyCompilerService {
  ...
  async simulate(params: SimulateParams): Promise<SimulateResult> {
    ...
    const { evaluateJsonLogic } = await import(
      "../../../framework/runtime/services/workflow/jsonlogic.js"
    );
