...
import { SqlOperationScopeArtifactImporter } from "../../../packages/services/iam/authorization-runtime/operation-scope-artifact-importer.js";
import { compileEntityPlaneArtifact } from "../../../packages/services/meta-entity-authoring/src/entity-plane-artifact-compiler.js";
import { canonicalizeMetaEntityGraph, validateMetaEntityGraph } from "../../../packages/services/meta-entity-authoring/src/meta-entity-graph.js";
  ...
  for (const target of targets) {
    ...
    try {
      const imported = await new SqlOperationScopeArtifactImporter(consumer).importArtifact({
        ...
        sourceCompiledArtifactId: stored.id, sourceCompiledHash: stored.compiled_hash,
      ...
      await consumer.executeQuery(CompiledQuery.raw(`select ops.set_authorization_operation_rollout(
        ...
        from authz.entity_operation_scope_binding
