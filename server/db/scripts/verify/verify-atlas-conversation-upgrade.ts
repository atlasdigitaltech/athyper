...
const checks: Check[] = [
  table("master", "atlas_thread"),
  table("master", "atlas_message"),
  table("event", "atlas_run"),
  table("control", "atlas_conversation_retention_policy"),
  column("master", "atlas_thread", "retention_policy_id"),
  column("master", "atlas_thread", "expires_at"),
  column("master", "atlas_thread", "purge_after"),
  column("master", "atlas_thread", "legal_hold"),
  column("master", "atlas_thread", "legal_hold_reference"),
  column("master", "atlas_message", "protected_content_ref"),
  column("event", "atlas_run", "client_request_id"),
  constraint("event", "atlas_run", "atlas_run_client_request_uq"),
  index("event", "atlas_run_one_started_per_thread_uq"),
  ...
  forcedRls("master", "atlas_thread"),
  forcedRls("master", "atlas_message"),
  forcedRls("event", "atlas_run"),
];
