DO $$ BEGIN
 IF current_database()<>'athyper_neon' OR current_setting('app.database_plane',true)<>'neon' THEN RAISE EXCEPTION 'Supplier registration permissions require NEON'; END IF;
END $$;
