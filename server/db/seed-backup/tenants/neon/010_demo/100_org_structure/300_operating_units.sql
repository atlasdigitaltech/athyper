...
--   seed/blueprints/universal/060_org_structure/300_org_units.sql
--
...
DO $seed$
BEGIN
    RAISE NOTICE '[300_operating_units] retired; universal org units are seeded by blueprints/universal/060_org_structure/300_org_units.sql';
END $seed$;
