...
--           shared.country, shared.timezone, shared.uom (reference data)
...
BEGIN
    ...
    -- capacity_uom stores shared.uom.code, not display labels or symbols.
    -- ════════════════════════════════════════════════════════════════════════
    ...
    ('AQTU', 'AQTU-SITE-PLANT-01', 'Main Generation Plant',
     ...
     'plant', 'QA', 'Asia/Qatar', 'MAW', 500.00);
    ...
    ('AUET', 'AUET-SITE-DC-01', 'Distribution Centre',
     ...
     'depot', 'AE', 'Asia/Dubai', 'MTK', 8000.00),
    ...
    ('ASAH', 'ASAH-SITE-HOTEL-01', 'Flagship Hotel',
     ...
     'branch', 'SA', 'Asia/Riyadh', 'EA', 350.00);
    ...
    ('AITM', 'AITM-SITE-PLANT-01', 'Main Textile Mill',
     ...
     'plant', 'IN', 'Asia/Kolkata', 'EA', 25000.00);
    ...
    ('ACFB', 'ACFB-SITE-PLANT-01', 'Main Processing Plant',
     ...
     'plant', 'CA', 'America/Toronto', 'TNE', 120.00);
    ...
    ('ADPM', 'ADPM-SITE-PLANT-01', 'GMP Manufacturing Plant',
     ...
     'plant', 'DE', 'Europe/Berlin', 'EA', 500000.00);
    ...
    ('ATEM', 'ATEM-SITE-PLANT-01', 'SMT Assembly Plant',
     ...
     'plant', 'TW', 'Asia/Taipei', 'EA', 80000.00);
    ...
    ('ASPE', 'ASPE-SITE-FIELD-01', 'Primary Extraction Field',
     ...
     'yard', 'ZA', 'Africa/Johannesburg', 'BLL', 15000.00);
    ...
    ('AUKA', 'AUKA-SITE-FARM-01', 'Main Farm Estate',
     ...
     'yard', 'GB', 'Europe/London', 'HAR', 850.00);
    ...
    ('AJED', 'AJED-SITE-CAMPUS-01', 'Main Campus',
     ...
     'branch', 'JP', 'Asia/Tokyo', 'EA', 5000.00);
    ...
    ('APHS', 'APHS-SITE-HOSPITAL-01', 'Main Hospital',
     ...
     'branch', 'PH', 'Asia/Manila', 'EA', 400.00);
    ...
    -- D-pre-3: Every capacity_uom must be a canonical shared.uom.code.
    SELECT count(*) INTO v_bad
    FROM tmp_site t
    WHERE t.capacity_uom IS NOT NULL
      AND NOT EXISTS (
          SELECT 1 FROM shared.uom u WHERE u.code = t.capacity_uom
      );
    IF v_bad > 0 THEN
        RAISE EXCEPTION '[303_sites] % tmp_site row(s) have unresolvable capacity_uom; use shared.uom.code values',
            v_bad;
    END IF;
