...
-- Phase 1 base: federal/country level for all 13 supported jurisdictions
...
BEGIN
    ...
    --       master.company_code         → master.tax_jurisdiction
    ...
    -- A3: No duplicate country_codes within the canonical universal L1 set.
    -- Tenant-specific retained jurisdictions are allowed to coexist; 303 links
    -- company codes by country after tenant/company onboarding completes.
    IF EXISTS (
