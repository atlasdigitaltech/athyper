...
BEGIN
    ...
    IF EXISTS (
        ...
        WHERE tenant_id = v_tenant_id
          AND code = 'APHS'
          AND metadata->'_seed'->>'pack' = '199_gl_preseed'
    ) AND EXISTS (
        SELECT 1
        ...
        RAISE NOTICE '[201_athyper_subsidiaries] Modern 199_gl_preseed org structure already present - legacy fixed UUID subsidiary seed skipped';
        RETURN;
    END IF;
    ...
    ('dd000017-0000-0000-0000-000000000001', v_tenant_id,
     ...
     'SA', 'SAR', 'USD', 'subsidiary', v_parent_le, 'full', 100.00, 'ifrs',
     v_meta, 'active', v_su),
    ...
    ('dd000023-0000-0000-0000-000000000001', v_tenant_id,
     ...
     'IN', 'INR', 'USD', 'subsidiary', v_parent_le, 'full', 100.00, 'ifrs',
     v_meta, 'active', v_su),
    ...
    ('dd000025-0000-0000-0000-000000000001', v_tenant_id,
     ...
     'DE', 'EUR', 'USD', 'subsidiary', v_parent_le, 'full', 100.00, 'ifrs',
     v_meta, 'active', v_su),
    ...
    ('dd000029-0000-0000-0000-000000000001', v_tenant_id,
     ...
     'JP', 'JPY', 'USD', 'subsidiary', v_parent_le, 'full', 100.00, 'ifrs',
     v_meta, 'active', v_su),
    ...
    ('ee000017-0000-0000-0000-000000000001', v_tenant_id,
     ...
     'SAR', 1, 'calendar', 'ifrs', true, v_meta, 'active', v_su),
    ...
    ('ee000023-0000-0000-0000-000000000001', v_tenant_id,
     ...
     'INR', 4, 'calendar', 'ifrs', true, v_meta, 'active', v_su),
    ...
    ('ee000025-0000-0000-0000-000000000001', v_tenant_id,
     ...
     'EUR', 1, 'calendar', 'ifrs', true, v_meta, 'active', v_su),
    ...
    ('ee000029-0000-0000-0000-000000000001', v_tenant_id,
     ...
     'JPY', 1, 'calendar', 'ifrs', true, v_meta, 'active', v_su),
