...
-- Purpose:  Subscribe CirrusAtlantic to all available non-partner modules.
...
BEGIN
    ...
    RAISE NOTICE '[001_module_subscriptions] CirrusAtlantic subscribed to non-partner modules';
