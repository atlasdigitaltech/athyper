-- ============================================================================
-- FILE: 040_modules/ap_non_po/060_category_intent_rules.sql
    ...
    LOOP
        FOR v_map IN SELECT * FROM tmp_root_intent_map LOOP
            ...
            SELECT id INTO v_cc_id
             ...
             WHERE tenant_id = v_tenant.tenant_id AND code = v_map.cc_code;

            SELECT id INTO v_bi_id
              FROM master.business_intent
             WHERE tenant_id = v_tenant.tenant_id AND code = v_map.bi_code;

            CONTINUE WHEN v_cc_id IS NULL OR v_bi_id IS NULL;
            ...
            SELECT v_tenant.tenant_id, 'COMMODITY_CATEGORY', v_cc_id, 'INBOUND',
