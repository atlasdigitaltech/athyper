-- 20260519_z_accounting_distribution_version_hash_refresh.sql
-- Refresh accounting_distribution version_hash after GL account lookup metadata changes
-- so compiled descriptor caches invalidate immediately.
