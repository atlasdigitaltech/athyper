...
WHERE table_schema = 'master'
  ...
  AND entity_code IN ('vendor_tax_profile', 'supplier_tax_profile', 'party_tax_profile', 'master_party_tax_profile')
...
SET display_config        = COALESCE(display_config, '{}'::jsonb) || jsonb_build_object(
    ...
    identity_config = jsonb_set(COALESCE(identity_config, '{}'::jsonb), '{natural_key_fields}', to_jsonb(ARRAY['country_code']::text[]), true)
