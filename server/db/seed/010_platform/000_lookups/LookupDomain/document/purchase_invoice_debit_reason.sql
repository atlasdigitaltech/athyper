-- LookupDomain/document/purchase_invoice_debit_reason.sql
-- Lookup values for domain: document.purchase_invoice_debit_reason
-- Reason selected for a buyer-issued debit note.
