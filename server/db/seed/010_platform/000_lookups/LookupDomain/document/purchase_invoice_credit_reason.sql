-- LookupDomain/document/purchase_invoice_credit_reason.sql
-- Lookup values for domain: document.purchase_invoice_credit_reason
-- Reason selected for a supplier credit note.
