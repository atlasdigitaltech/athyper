-- Table-owned seed for control.entity
-- One canonical bulk upsert plus one legacy cleanup pass.
-- Entity identity is derived from the physical table:
--   name = entity_code = table_name
--   slug = replace(table_name, '_', '-')
...
curated_overrides (
    ...
    VALUES
        ...
        ('document', 'purchase_invoice', 'ACC', 'INV', 'DOCUMENT', 'ent', 'table', 'full', 'tenant_critical', 'controlled', 'Purchase Invoice', 'Purchase Invoices', 'file-text', 'violet', '{"is_approvable":true,"has_workflow":true,"document_category":"payables","allow_on_behalf_of":false,"has_lines":true,"catalog_feature_enabled":false,"auto_number":true}'::jsonb, '{}'::jsonb, '{}'::jsonb, '{}'::jsonb, '{}'::jsonb, '{}'::jsonb, 'ACTIVE'),
        ('document', 'purchase_invoice_line', 'ACC', 'PINV_L', 'DOCUMENT_RELATION', 'ent', 'table', 'full', 'tenant_critical', 'controlled', 'Invoice Line', 'Invoice Lines', 'list', 'violet', '{"parent_entity":"purchase_invoice","has_accounting_distribution":true,"has_matching":true}'::jsonb, '{}'::jsonb, '{}'::jsonb, '{}'::jsonb, '{}'::jsonb, '{}'::jsonb, 'ACTIVE'),
        ('document', 'purchase_order', 'BUY', 'PO', 'DOCUMENT', 'ent', 'view', 'full', 'tenant_critical', 'controlled', 'Purchase Order', 'Purchase Orders', 'shopping-cart', 'orange', '{"is_approvable":true,"has_workflow":true,"document_category":"purchasing","allow_on_behalf_of":false,"has_lines":true,"auto_number":true,"write_facade":"PurchaseOrderFacade","backing_source":"commitment+commitment_procurement"}'::jsonb, '{}'::jsonb, '{}'::jsonb, '{}'::jsonb, '{}'::jsonb, '{}'::jsonb, 'ACTIVE'),
        ...
        -- ── Tier 1: Shared Reference (locked, config) ─────────────────────────
        ('shared', 'country',            'REL', 'CTY',  'REFERENCE', 'ent', 'table', 'standard', 'config', 'locked',     'Country',            'Countries',            'globe',      'blue',   '{"is_lookupable":true}'::jsonb,                                        '{}'::jsonb, '{"title_field":"name","subtitle_field":"code3"}'::jsonb,         '{"enabled":true,"fields":["name","code","code3","numeric3","calling_code"]}'::jsonb,          '{}'::jsonb, '{}'::jsonb, 'ACTIVE'),
        ('shared', 'currency',           'REL', 'CUR',  'REFERENCE', 'ent', 'table', 'standard', 'config', 'locked',     'Currency',           'Currencies',           'coins',      'green',  '{"is_lookupable":true}'::jsonb,                                        '{}'::jsonb, '{"title_field":"name","subtitle_field":"code"}'::jsonb,           '{"enabled":true,"fields":["name","code","symbol","minor_units","numeric3"]}'::jsonb,          '{}'::jsonb, '{}'::jsonb, 'ACTIVE'),
        ('shared', 'language',           'REL', 'LNG',  'REFERENCE', 'ent', 'table', 'standard', 'config', 'locked',     'Language',           'Languages',            'languages',  'indigo', '{"is_lookupable":true}'::jsonb,                                        '{}'::jsonb, '{"title_field":"name","subtitle_field":"code"}'::jsonb,           '{"enabled":true,"fields":["name","code","native_name","iso639_2"]}'::jsonb,                   '{}'::jsonb, '{}'::jsonb, 'ACTIVE'),
        ('shared', 'locale',             'REL', 'LCL',  'REFERENCE', 'ent', 'table', 'standard', 'config', 'locked',     'Locale',             'Locales',              'map',        'cyan',   '{"is_lookupable":true}'::jsonb,                                        '{}'::jsonb, '{"title_field":"name","subtitle_field":"code"}'::jsonb,           '{"enabled":true,"fields":["name","code","language_code","country_code"]}'::jsonb,             '{}'::jsonb, '{}'::jsonb, 'ACTIVE'),
        ('shared', 'timezone',           'REL', 'TZN',  'REFERENCE', 'ent', 'table', 'standard', 'config', 'locked',     'Timezone',           'Timezones',            'clock',      'slate',  '{"is_lookupable":true}'::jsonb,                                        '{}'::jsonb, '{"title_field":"name","subtitle_field":"code"}'::jsonb,           '{"enabled":true,"fields":["name","code","utc_offset_minutes"]}'::jsonb,                      '{}'::jsonb, '{}'::jsonb, 'ACTIVE'),
        ('shared', 'uom',                'REL', 'UOM',  'REFERENCE', 'ent', 'table', 'standard', 'config', 'locked',     'Unit of Measure',    'Units of Measure',     'ruler',      'purple', '{"is_lookupable":true}'::jsonb,                                        '{}'::jsonb, '{"title_field":"name","subtitle_field":"code"}'::jsonb,           '{"enabled":true,"fields":["name","code","symbol","quantity_type"]}'::jsonb,                   '{}'::jsonb, '{}'::jsonb, 'ACTIVE'),
        ('shared', 'state_region',       'REL', 'STR',  'REFERENCE', 'ent', 'table', 'standard', 'config', 'locked',     'State / Region',     'States & Regions',     'map-pin',    'amber',  '{"is_lookupable":true,"parent_entity":"country"}'::jsonb,              '{}'::jsonb, '{"title_field":"name","subtitle_field":"code"}'::jsonb,           '{"enabled":true,"fields":["name","code","country_code","category"]}'::jsonb,                  '{}'::jsonb, '{}'::jsonb, 'ACTIVE'),
        ...
        -- ── Tier 2: Crosswalk / Mapping (controlled — admin import only) ───────
        ...
        -- ── Tier 4: Entitlements (full, platform_critical) ─────────────────────
...
resolved AS (
    SELECT
        ...
        ) || cc.identity_config AS resolved_identity_config
