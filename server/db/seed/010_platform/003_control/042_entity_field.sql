-- Table-owned seed for control.entity_field
...
-- Field definitions use conflict-updating upserts; fold metadata changes into the
-- entity's row set instead of adding insert-then-update pairs.
...
-- Generic schema-derived fallback.
-- 040_entity.sql registers all active system entities from information_schema.
-- Keep field metadata equally broad so every active entity has a usable
-- compiled shape after an explicit metadata rebuild. Curated blocks below run
-- afterwards and override labels/types/config for high-touch runtime entities.
...
SELECT
    ...
    CASE
        ...
        WHEN col.data_type = 'ARRAY' THEN 'array'
        ELSE 'text'
    END,
    CASE
        WHEN col.column_name LIKE '%\_id' ESCAPE '\' THEN 'reference'
    ...
    END,
    'standard',
    (col.is_nullable = 'NO' AND col.column_default IS NULL AND col.is_generated = 'NEVER'),
    (
    ...
    (
        col.column_name IN ('id', 'tenant_id', 'created_at', 'created_by', 'updated_at', 'updated_by')
...
-- â”€â”€ business_partner_bank_account: entity_field â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- 3. control.entity_field â€” request_scope
INSERT INTO control.entity_field (
    entity_version_id, name, column_name, label, data_type,
    cardinality, origin, enum_domain_code, is_required, is_filterable,
    validation, sort_order, created_by)
...
-- 4. control.entity_field â€” change_reason
INSERT INTO control.entity_field (
    entity_version_id, name, column_name, label, data_type,
...
-- ============================================================
-- SOURCE: server/db/seed/010_platform/004_entity_engine/025_entity_versions_and_canonical_fields.sql
-- ============================================================


-- === SOURCE: 030_canonical_fields/000_canonical_dictionary.sql ===
...
INSERT INTO control.entity_field (
    ...
    -- â”€â”€ System identity â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    (NULL, NULL,
    ...
    -- â”€â”€ Standard identity â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    (NULL, NULL,
    ...
    -- â”€â”€ Lifecycle / Status â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    (NULL, NULL,
...
-- ============================================================
-- SOURCE: server/db/seed/010_platform/004_entity_engine/065_entity_flows.sql
-- ============================================================


-- === SOURCE: 023_entity_field_fixes.sql ===
-- =============================================================================
-- 023_entity_field_fixes.sql
-- Fixes two categories of entity_field seed errors:
--
-- Â§1  payment_term_id ref_entity: 'payment_terms' â†’ 'payment_term' (singular)
...
--
-- Â§2  Remove spurious 'name', 'code', 'description' entity_field rows seeded
...
--     The missing column caused listHandler ORDER BY "name" â†’ 500.
--
...
BEGIN
  ...
  -- â”€â”€ Â§1  Fix payment_term_id ref_entity â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  RAISE NOTICE '023 Â§1: payment_term_id ref_entity corrected (% rows updated)', updated;

  -- â”€â”€ Â§2  Remove spurious name/code/description fields for tables lacking them â”€
  ...
  RAISE NOTICE '023 Â§2: removed % spurious name/code/description entity_field rows', deleted;

END $$;


-- ============================================================
-- SOURCE: server/db/seed/010_platform/005_domain_registrations/100_master/000_business_partner.sql
-- ============================================================



-- â”€â”€ 3. control.entity_field â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
INSERT INTO control.entity_field (
    entity_version_id, name, column_name, label, data_type,
    cardinality, origin, enum_domain_code, is_required, is_filterable,
    validation, sort_order, created_by)
...
-- â”€â”€ Upgrade legal_form to enum (master.legal_form) if previously text â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ Pin id/tenant_id as system/hidden â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
UPDATE control.entity_field ef
SET origin  = 'system',
    ui_type = 'hidden'
FROM control.entity_version ev
...
-- ============================================================
-- SOURCE: server/db/seed/010_platform/005_domain_registrations/100_master/001_supplier.sql
-- ============================================================



-- Entity registration moved to 004_entity_engine/020_entities/006_domain_entities.sql

-- â”€â”€ 2b. Remove stale field registrations from pre-BP-first schema â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ 3. control.entity_field â€” thin AP role fields â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ 3b. BP-sourced identity fields (origin='system', read-only in edit mode) â”€â”€
...
-- â”€â”€ 4. Set ui_type for country picker â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- field_group inserts moved to 004_entity_engine/002_field_groups.sql
...
-- â”€â”€ 7. Pin id and tenant_id as system/hidden (never rendered in UI) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
-- origin='system' â†’ FieldsRenderer excludes field from view grid
-- ui_type='hidden' â†’ edit-mode field renderer registry uses no-op renderer
...
-- ============================================================
-- SOURCE: server/db/seed/010_platform/005_domain_registrations/100_master/003_customer.sql
-- ============================================================



-- â”€â”€ 0b. Remove stale field registrations from pre-BP-first schema â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ 3. control.entity_field â€” thin AR role fields â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
INSERT INTO control.entity_field (
    entity_version_id, name, column_name, label, data_type,
    cardinality, origin, enum_domain_code, is_required, is_filterable,
    validation, sort_order, created_by)
...
-- ============================================================
-- SOURCE: server/db/seed/010_platform/005_domain_registrations/100_master/003_supplier_children.sql
-- ============================================================
...
-- vat_registered â†’ is_vat_registered (boolean naming convention)
INSERT INTO control.entity_field (
    entity_version_id, name, column_name, label, data_type,
    cardinality, origin, enum_domain_code, is_required, is_filterable,
    validation, sort_order, created_by)
...
-- â”€â”€ 3. control.entity_field â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
-- FK reference columns (ending _id) â†’ data_type 'uuid' per ef_id_suffix_chk
INSERT INTO control.entity_field (
    entity_version_id, name, column_name, label, data_type,
    cardinality, origin, enum_domain_code, is_required, is_filterable,
    validation, sort_order, created_by)
...
-- Channels â†’ master.contact_link; addresses â†’ master.address_link.
CROSS JOIN (VALUES
...
-- â”€â”€ 4. Deactivate stale inline contact/address fields â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
UPDATE control.entity_field ef
SET is_active = false
FROM control.entity_version ev
JOIN control.entity e ON e.id = ev.entity_id
...
-- === SOURCE: 002_supplier_ext_fields.sql ===
...
-- â”€â”€ Migration: neutralize domain refs on existing rows â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
UPDATE control.entity_field ef
...
-- entity_flow for business_partner_identifier moved to 004_entity_engine/065_entity_flows.sql


-- ============================================================
-- SOURCE: server/db/seed/010_platform/005_domain_registrations/100_master/007_business_partner_address.sql
-- ============================================================
...
-- ============================================================
-- SOURCE: server/db/seed/010_platform/005_domain_registrations/100_master/008_supplier_block.sql
-- ============================================================
...
-- ============================================================
-- SOURCE: server/db/seed/010_platform/005_domain_registrations/100_master/009_customer_ext_fields.sql
-- ============================================================

-- 100_master/009_customer_ext_fields.sql
-- Purpose: Align customer entity registration with the three-party master model.
-- Â§1: Deactivate stale AR-behavior fields (belong in company_code_customer_profile)
-- Â§2: Fix tax_number column_name mapping (DB column is tax_id)
-- Â§3: Add missing core identity/legal fields
-- Â§4: Add extended business profile fields (mirror of 002_supplier_ext_fields.sql)
-- Idempotent: update guards plus conflict-updating upserts

-- â”€â”€ Â§1. Deactivate stale fields â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
UPDATE control.entity_field ef
SET is_active = false
FROM control.entity_version ev
JOIN control.entity e ON e.id = ev.entity_id
...
-- â”€â”€ Â§2. Fix tax_number column_name (DB column is tax_id, not tax_number) â”€â”€â”€â”€â”€â”€
UPDATE control.entity_field ef
...
-- â”€â”€ Â§3. Add missing core identity / legal fields â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
INSERT INTO control.entity_field (
    entity_version_id, name, column_name, label, data_type,
    cardinality, origin, enum_domain_code, is_required, is_filterable,
    validation, sort_order, created_by)
...
-- â”€â”€ Â§4. Extended business profile fields â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
INSERT INTO control.entity_field (
    entity_version_id, name, column_name, label, data_type,
    cardinality, origin, enum_domain_code, is_required, is_filterable,
    validation, sort_order, created_by)
...
-- ============================================================
-- SOURCE: server/db/seed/010_platform/005_domain_registrations/100_master/010_company_code_profiles.sql
-- ============================================================
...
-- === SOURCE: 015_customer_qualification.sql ===
...
-- === SOURCE: 016_supplier_qualification.sql ===
...
-- â”€â”€ 3. control.entity_field â€” core statutory / finance fields â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
INSERT INTO control.entity_field (
    entity_version_id, name, column_name, label, data_type,
    cardinality, origin, enum_domain_code, is_required, is_filterable,
    validation, sort_order, created_by)
...
-- â”€â”€ 4. Extended profile fields (added via 01i_tables_party_master.sql) â”€â”€â”€â”€â”€â”€â”€â”€
INSERT INTO control.entity_field (
    entity_version_id, name, column_name, label, data_type,
    cardinality, origin, enum_domain_code, is_required, is_filterable,
    validation, sort_order, created_by)
...
-- â”€â”€ 5. Migration: update existing rows to reflect corrections â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- === SOURCE: 018_customer_app_index.sql ===
-- 100_master/018_customer_app_index.sql
-- Purpose: control.entity + entity_version + entity_field for customer_app_index
-- Module: CRM (Customer Relationship Management)
-- Role: INDEX entity â€” denormalized list/search surface for master.customer_app_index
-- entity_class = 'AGGREGATE' â€” read-only from app; written exclusively by DB triggers
-- Idempotent: conflict-updating upserts
...
-- === SOURCE: 017_supplier_app_index.sql ===
-- 100_master/017_supplier_app_index.sql
-- Purpose: control.entity + entity_version + entity_field for supplier_app_index
-- Module: BUY (Buying)
-- Role: INDEX entity â€” denormalized list/search surface for master.supplier_app_index
-- entity_class = 'AGGREGATE' â€” read-only from app; written exclusively by DB triggers
-- Idempotent: conflict-updating upserts
...
-- â”€â”€ 3. control.entity_field â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
-- All columns are standard/system â€” no user-configurable fields on an index entity.
...
CROSS JOIN (VALUES
    ...
    -- Search surface â€” single searchable field covering all key text content
    ('search_text',                'search_text',                'Search',                  'text',          'one',        NULL::text,                   false, false, true,  NULL::jsonb,                 200)
) AS f(name, column_name, label, data_type, cardinality, enum_domain_code,
       is_required, is_filterable, is_searchable, validation, sort_order)
...
-- === SOURCE: 020_company_code_supplier_intent_policy.sql ===
...
-- â”€â”€ 1+2. entity/entity_version extracted to 006_domain_entities.sql â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- === SOURCE: 021_company_code_supplier_posting_override.sql ===
...
-- â”€â”€ 3. control.entity_field (26 fields) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
JOIN control.entity e ON e.id = ev.entity_id
CROSS JOIN (VALUES
    -- â”€â”€ A: Identity & Classification â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    -- â”€â”€ B: Counterparty & Dates â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    -- â”€â”€ C: Currency & Amounts â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    -- â”€â”€ E: Matching & Hold â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    -- â”€â”€ F: Dimensions & Fiscal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ Extended fields missing from v1 registration â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ Fix ref_entity: "supplier" on already-seeded rows (was "vendor") â”€â”€â”€â”€â”€â”€â”€â”€
UPDATE control.entity_field ef
...
-- â”€â”€ Fix origin for existing rows (idempotent) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
UPDATE control.entity_field ef
SET origin = 'standard'
FROM control.entity_version ev
JOIN control.entity e ON e.id = ev.entity_id
...
-- â”€â”€ Mark searchable fields (idempotent) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ 3b. Full-coverage entity fields â€” all remaining business columns â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
JOIN control.entity e ON e.id = ev.entity_id
CROSS JOIN (VALUES
    -- â”€â”€ A: Identity additions (15, 22) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    -- â”€â”€ B: Counterparty & Dates additions (42, 47, 57) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    -- â”€â”€ C: Currency & Amounts additions (72â€“109) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ('base_currency_code',     'base_currency_code',      'Base Currency',      'text',      'one',         NULL::text,                                   true,  true,  '{"max_length":3}'::jsonb,            72),
    ('exchange_rate',          'exchange_rate',           'Exchange Rate',      'decimal',   'zero_or_one', NULL::text,                                   false, false, '{"min":0}'::jsonb,                   74),
    ...
    -- â”€â”€ D: References & Terms additions (142â€“147) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ('payment_method_id',      'payment_method_id',       'Payment Method',     'reference', 'zero_or_one', NULL::text,                                   false, false, '{"ref_entity":"payment_method"}'::jsonb, 142),
    ...
    -- â”€â”€ E: Matching, Hold & Budget additions (162â€“168) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    -- â”€â”€ F: Dimensions additions (205, 215) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ Patch: rename 'Vendor Ref' / 'Vendor Invoice No.' â†’ 'Supplier Invoice No.' on already-seeded rows â”€â”€
UPDATE control.entity_field ef
...
-- â”€â”€ 3. control.entity_field (13 fields) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
INSERT INTO control.entity_field (
    entity_version_id, name, column_name, label, data_type,
    cardinality, origin, enum_domain_code, is_required, is_filterable,
    validation, sort_order, created_by)
...
-- â”€â”€ Fix data_type 'ref' â†’ 'reference' on already-seeded rows â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
UPDATE control.entity_field ef
...
-- â”€â”€ 2. control.entity_field (9 fields) â€” entity/entity_version extracted to 006_domain_entities.sql â”€â”€
INSERT INTO control.entity_field (
    entity_version_id, name, column_name, label, data_type,
    cardinality, origin, enum_domain_code, is_required, is_filterable, is_searchable,
    validation, sort_order, created_by)
...
-- â”€â”€ Enable full-text search on key text fields (idempotent) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ Fix column_name mismatches for existing rows (idempotent) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ 2. entity_version extracted to 006_domain_entities.sql â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

-- â”€â”€ 3. control.entity_field (14 fields) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
INSERT INTO control.entity_field (
    entity_version_id, name, column_name, label, data_type,
    cardinality, origin, enum_domain_code, is_required, is_filterable,
    validation, sort_order, created_by)
...
-- â”€â”€ 7. Fix ref_entity: "supplier" on already-seeded rows (was "vendor") â”€â”€â”€â”€â”€â”€
UPDATE control.entity_field ef
...
-- ============================================================
-- SOURCE: server/db/seed/010_platform/005_domain_registrations/200_document/003_document_relations.sql
-- ============================================================


-- â”€â”€ 3. control.entity_field (27 fields) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
JOIN control.entity e ON e.id = ev.entity_id
CROSS JOIN (VALUES
    -- â”€â”€ A: Identity & Parent â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    -- â”€â”€ B: Item Classification â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    -- â”€â”€ C: Quantity & Pricing â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    -- â”€â”€ D: Tax, Gross & Retention â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    -- â”€â”€ E: Dimensions â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    -- â”€â”€ F: Matching & Asset â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ 7. Field group registry â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
-- field_group inserts moved to 004_entity_engine/002_field_groups.sql

-- â”€â”€ 8. Group-key patches on existing 27 fields â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
-- Merges group_key into ui_hint without touching line_grid hints set in Â§4.
UPDATE control.entity_field ef
SET ui_hint = COALESCE(ef.ui_hint, '{}'::jsonb)
...
-- â”€â”€ 9. FK reference link fields (matching group) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
UPDATE control.entity_field ef
SET ui_hint = COALESCE(ef.ui_hint, '{}'::jsonb)
...
-- â”€â”€ 2. control.entity_version â€” extracted to 006_domain_entities.sql â”€â”€â”€â”€â”€â”€â”€â”€

-- â”€â”€ 3. control.entity_field (22 fields) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
JOIN control.entity e ON e.id = ev.entity_id
CROSS JOIN (VALUES
    -- â”€â”€ A: Source Document â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    -- â”€â”€ B: Split Basis & Amounts â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    -- â”€â”€ C: Account Resolution â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    -- â”€â”€ D: Dimensions â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    -- â”€â”€ E: Flags, Budget & Narrative â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- ---------------------------------------------------------------------------
-- Â§C0  Remove stale old-name rows that may have been re-inserted by a
...
-- ---------------------------------------------------------------------------
-- Â§F1  Rename gross_amount â†’ total_amount
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Â§F2  Rename supplier_invoice_number (was vendor_invoice_ref)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Â§F4  Upsert tax_mode_source field
-- ---------------------------------------------------------------------------
...
SELECT
    ...
    'standard',
    'Tax Mode Source',
    'How tax_mode was determined â€” for audit trail and UI attribution.',
...
-- === SOURCE: _retired/001b_invoice_name_field_patch.sql ===
-- 001b_invoice_name_field_patch.sql
-- Renames the description field label from "Description" â†’ "Invoice Name"
-- and tightens max_length from 500 â†’ 200 for the purchase_invoice entity.
...
-- === SOURCE: 002_commodity_category_policy_apps.sql ===
