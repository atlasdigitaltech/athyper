...
-- ============================================================
-- SOURCE: server/db/seed/010_platform/007_blueprint_registry/000_blueprint_registry.sql
-- ============================================================

-- ============================================================================
-- BLUEPRINT REGISTRY — SEED DATA
-- ============================================================================
-- File:     010_platform/007_blueprint_registry/000_blueprint_registry.sql
-- Schema:   control
...
-- ════════════════════════════════════════════════════════════════════════════
-- pack_ap_non_po  →  see 010_platform/007_blueprint_registry/001_ap_non_po_registry.sql
...
-- ============================================================
-- SOURCE: server/db/seed/010_platform/007_blueprint_registry/002_finance_close_governance_registry.sql
-- ============================================================
...
VALUES (
    ...
    ARRAY[
        '040_modules/governance/010_finance_close_governance_templates.sql',
        '040_modules/governance/099_apply.sql'
    ],
...
-- ============================================================
-- SOURCE: server/db/seed/010_platform/007_blueprint_registry/001_ap_non_po_registry.sql
-- ============================================================

-- ============================================================================
-- BLUEPRINT REGISTRY — TIER 3: MODULE PACKS
-- ============================================================================
-- File:     010_platform/007_blueprint_registry/001_ap_non_po_registry.sql
-- Schema:   control
...
VALUES (
    ...
    ARRAY[
        ...
        '030_industry/600_modules/ap_non_po/099_apply.sql'
    ],
