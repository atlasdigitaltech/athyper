...
FROM (VALUES
    ('purchase_invoice',
     ...
     'Accounts Payable (AP) invoice from a supplier.',
     10),
    ('sales_invoice',
     'Sales Invoice',
     'control.document_sequence_doc_type',
    ...
    ('credit_note',
     'Credit Note',
     'control.document_sequence_doc_type',
     'Credit memo issued to a customer or received from a supplier.',
     30),
    ('debit_note',
     'Debit Note',
     'control.document_sequence_doc_type',
     'Debit memo issued to a customer or sent to a supplier.',
     40),
    ('payment_entry',
     'Payment Entry',
     'control.document_sequence_doc_type',
