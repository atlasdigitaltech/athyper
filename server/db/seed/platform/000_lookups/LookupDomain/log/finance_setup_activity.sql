...
FROM (VALUES
    ...
    ('finance_setup.fx_rate_replaced', 'FX Rate Replaced', 'log.activity_type',
     'An immutable active FX quote was superseded by a lineage-linked successor.', 227),
    ('finance_setup.fx_tenant_policy_created', 'Tenant FX Policy Created', 'log.activity_type',
     'An append-only Tenant FX default policy was created.', 228),
    ('finance_setup.fx_policy_replaced', 'FX Policy Replaced', 'log.activity_type',
     'An FX policy was replaced by a scope-preserving lineage successor.', 229),
    ('finance_setup.fx_policy_ended', 'FX Policy Ended', 'log.activity_type',
     'A Company or Book FX override was ended without deleting history.', 230),
    ('finance_setup.fx_rate_created', 'FX Rate Created', 'log.activity_type',
     'A new immutable FX quote was created through the governed command.', 231),
