-- LookupDomain/document/purchase_invoice_recovery_method.sql
-- Lookup values for domain: document.purchase_invoice_recovery_method
-- How an advance payment is recovered from future invoices.
