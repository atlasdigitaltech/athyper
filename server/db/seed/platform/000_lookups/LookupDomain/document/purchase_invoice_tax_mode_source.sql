-- LookupDomain/document/purchase_invoice_tax_mode_source.sql
-- Lookup values for domain: document.purchase_invoice_tax_mode_source
-- How tax_mode was determined on an AP invoice (audit trail + UI attribution).
