...
FROM (VALUES
    ...
    ('grid.default_saved_view',
     'Default Saved View',
     'ui.preference_code',
     'Principal default saved view per entity list surface. '
     'preference_value schema: {"entity_defaults":{"gl_account":"<saved_view_uuid>"}}.',
     13,
     '{"value_schema":{"type":"object","properties":{"entity_defaults":{"type":"object"}}}}'),
