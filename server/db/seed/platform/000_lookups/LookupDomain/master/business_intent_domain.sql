-- LookupDomain/master/business_intent_domain.sql
-- Lookup values for domain: master.business_intent.domain
-- Purpose/domain classification for business intents.
