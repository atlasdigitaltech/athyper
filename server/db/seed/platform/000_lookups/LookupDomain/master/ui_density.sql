...
FROM (VALUES
    ('compact',     'Compact',     'ui.density', 'Default density with minimal row height and whitespace.',              10),
    ('comfortable', 'Comfortable', 'ui.density', 'Balanced spacing. Prioritises readability and touch targets.',          20),
