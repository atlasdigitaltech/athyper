-- LookupDomain/master/business_intent_visibility.sql
-- Lookup values for domain: master.business_intent.visibility
-- Visibility classification for business intents.
