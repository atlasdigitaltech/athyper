...
curated_overrides (
    ...
    VALUES
        ...
        ('document', 'journal_entry', 'ACC', 'JE', 'DOCUMENT', 'ent', 'table', 'full', 'tenant_critical', 'controlled', 'Journal Entry', 'Journal Entries', 'book-open', 'slate', '{"is_approvable":true,"has_workflow":true,"document_category":"general_ledger","allow_on_behalf_of":false,"has_lines":true,"auto_number":true}'::jsonb, '{"list_renderer":"table","view_modes":["table","compact","spreadsheet"],"list_features":{"saved_views":true,"bulk_actions":true,"export":true,"import":true,"column_customization":true,"grouping":true,"multi_sort":true,"max_sort_levels":3,"search_mode":"both","max_page_size":200}}'::jsonb, '{}'::jsonb, '{}'::jsonb, '{}'::jsonb, '{}'::jsonb, 'ACTIVE'),
        ...
        ('document', 'purchase_invoice', 'ACC', 'INV', 'DOCUMENT', 'ent', 'table', 'full', 'tenant_critical', 'controlled', 'Purchase Invoice', 'Purchase Invoices', 'file-text', 'violet', '{"is_approvable":true,"has_workflow":true,"document_category":"payables","allow_on_behalf_of":false,"has_lines":true,"catalog_feature_enabled":false,"auto_number":true}'::jsonb, '{"line_ui_variant":"procure","line_entity_code":"purchase_invoice_line","list_renderer":"table","view_modes":["table","compact","spreadsheet"],"list_features":{"saved_views":true,"bulk_actions":true,"export":true,"import":true,"column_customization":true,"grouping":true,"multi_sort":true,"max_sort_levels":3,"search_mode":"both","max_page_size":200}}'::jsonb, '{}'::jsonb, '{}'::jsonb, '{}'::jsonb, '{}'::jsonb, 'ACTIVE'),
