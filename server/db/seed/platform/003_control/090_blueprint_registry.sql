-- Table-owned seed for control.blueprint_registry
...
-- ============================================================
-- SOURCE: server/db/seed/platform/007_blueprint_registry/000_blueprint_registry.sql
-- ============================================================

-- ============================================================================
-- BLUEPRINT REGISTRY — SEED DATA
-- ============================================================================
-- File:     platform/007_blueprint_registry/000_blueprint_registry.sql
-- Schema:   control
...
--             Taxonomy files live in: blueprints/industry/100_industry_packs/
--             Org extension templates live in: blueprints/industry/200_org_structure/
--
...
--             Files live in: blueprints/modules/
...
-- rows exist; the provisioner treats blueprints/universal/060_org_structure as a
...
-- ════════════════════════════════════════════════════════════════════════════
-- pack_ap_non_po  →  see platform/007_blueprint_registry/001_ap_non_po_registry.sql
...
-- ============================================================
-- SOURCE: server/db/seed/platform/007_blueprint_registry/002_finance_close_governance_registry.sql
-- ============================================================

-- ============================================================================
-- BLUEPRINT REGISTRY - TIER 3: MODULE PACKS
-- ============================================================================
-- Purpose: Register Finance Close Governance module pack.
-- Depends: control.blueprint_registry
-- Idempotent: Yes - ON CONFLICT (code) DO UPDATE
-- ============================================================================
...
-- ============================================================
-- SOURCE: server/db/seed/platform/007_blueprint_registry/001_ap_non_po_registry.sql
-- ============================================================

-- ============================================================================
-- BLUEPRINT REGISTRY — TIER 3: MODULE PACKS
-- ============================================================================
-- File:     platform/007_blueprint_registry/001_ap_non_po_registry.sql
-- Schema:   control
-- Purpose:  Register the AP Non-PO module pack in control.blueprint_registry.
--           Follows the same pattern as 000_blueprint_registry.sql.
--           Additional Tier 3 packs: add 002_*_registry.sql alongside this file.
-- Depends:  control.blueprint_registry (created by 01_tables.sql §PROV-1)
-- Idempotent: Yes — ON CONFLICT (code) DO UPDATE
-- seed_files paths: relative to 900_seed_data/ root
-- ============================================================================
