...
-- ============================================================
-- SOURCE: server/db/seed/platform/004_entity_engine/010_lifecycles.sql
-- ============================================================
...
-- Idempotent: additive upserts only. System lifecycle IDs must remain stable
-- because downstream rows reference them through restrictive foreign keys.
