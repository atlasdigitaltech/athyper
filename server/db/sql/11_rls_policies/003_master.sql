...
-- Depends on: 04_tables/003_master.sql, 05_pre_constraint_functions/001_shared (shared.current_tenant_id_soft)
-- Tenant sees only its own row. Admin sees all. No tenant self-mutation.
