...
CREATE POLICY tenant_read   ON log.audit_log FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON log.security_event_log FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON log.permission_decision_log FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON log.field_access_log FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON log.attachment_access_log FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON log.share_audit_log FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON log.entity_lifecycle_log FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON log.workflow_event_log FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON log.close_override_log FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON log.job_log FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON log.policy_evaluation_log FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON log.hash_anchor FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON log.dimension_resolution_log FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON log.activity_log FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON log.close_activity_log FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON log.export_log FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON log.comment_retention_log FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON log.search_history FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON log.ai_inference_log FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON log.ai_monitoring_log FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON log.ai_feedback_log FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON log.ai_calibration_log FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON log.ai_call_transcript FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON log.kpi_execution_log FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON log.workspace_usage_metric FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON log.render_dlq FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON log.cycle_audit_log FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON log.resolution_log FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
