-- 11_rls_policies/008_governance.sql
-- Governance schema RLS policies.
...
CREATE POLICY tenant_read   ON governance.book_period_status FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON governance.cycle_type FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON governance.cycle_phase FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON governance.cycle_task_category FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON governance.cycle_task_template FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON governance.cycle_task_dependency FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON governance.cycle_run FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON governance.cycle_task FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON governance.cycle_deviation FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON governance.cycle_certification FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON governance.cycle_cross_dependency FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON governance.cycle_carryforward_rule FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
