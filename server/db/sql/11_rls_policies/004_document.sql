-- 11_rls_policies/004_document.sql
-- Document schema RLS policies.
...
CREATE POLICY tenant_read   ON document.render_output FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON document.render_job FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON document.journal_entry FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON document.journal_line FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON document.journal_line_reference FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON document.obligation_horizon FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON document.asset_transaction FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON document.depreciation_run FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON document.depreciation_run_line FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
...
CREATE POLICY tenant_read   ON document.depreciation_schedule FOR SELECT USING     (tenant_id = shared.current_tenant_id_soft());
