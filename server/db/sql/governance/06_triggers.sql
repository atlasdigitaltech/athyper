...
-- Concept: Governance Triggers — cycle timing, SLA enforcement, and certification triggers
-- Depends on: 04_tables/008_governance.sql, 08_functions/008_governance.sql
