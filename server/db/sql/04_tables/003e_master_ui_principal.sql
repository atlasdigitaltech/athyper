...
--
-- Depends on:
--   04_tables/003_master.sql        (master.tenant, master.principal, master.tenant_profile)
--   04_tables/003a_master_identity.sql (master.principal_profile)
--   04_tables/003b_master_finance.sql  (master.company_code, master.operating_unit,
--                                       master.ledger_book)
--   shared.locale, shared.language, shared.timezone (shared reference tables)
--   shared.workspace, shared.module    (navigation references)
--   shared.uuidv7()                    (default id generator)
--   control.lookup_domain / control.lookup_value (seeded in 900_seed_data)
--
