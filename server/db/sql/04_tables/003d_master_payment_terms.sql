-- ============================================================================
-- PAYMENT TERMS & HOLIDAY CALENDAR — master schema DDL
-- ============================================================================
-- Tables:
...
--
-- Depends on: shared.uuidv7(), shared.country, shared.currency,
--             master.tenant, master.company_code, master.legal_entity,
--             master.site, master.principal,
--             document.commitment, document.workflow_request,
--             ledger.commitment_schedule,
--             control.lookup_domain, control.lookup_value,
