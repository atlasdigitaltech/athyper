...
run_file "$SQL_DIR/00_platform/000_roles.sql"
run_file "$SQL_DIR/00_platform/001_extensions.sql"
run_file "$SQL_DIR/00_platform/002_schemas.sql"
run_file "$SQL_DIR/00_platform/002b_int_schema.sql"
run_file "$SQL_DIR/00_platform/003_domains.sql"
...
run_file "$SQL_DIR/99_security/800_security_hardening.sql"
