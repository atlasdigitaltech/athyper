...
-- FK constraints for the document schema (workflow, render, journal, commitment, attachments,
-- invoice, payment, assets, intercompany, inventory, P2P).
-- Merged from: (base) + 004a_document_journal.sql through 004i_document_p2p.sql

-- 06_constraints/004_document.sql
-- Scope: Platform / Workflow / Render foreign-key constraints
-- Tables: workflow_request, workflow_stage, user_profile_update_request,
--         render_output, render_job
-- Depends on: 06_constraints/002_control.sql, 06_constraints/003_master.sql,
