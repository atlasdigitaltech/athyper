...
--
-- Blueprint selection:
--   COA framework   → exactly one of: coa_ifrs | coa_gaap | coa_mfrs
--   Industry packs  → one or more from 030_industry/100_industry_packs/
--   Module packs    → per subscription from 030_industry/600_modules/
-- ============================================================================
...
INSERT INTO control.tenant_provisioning_request (
    tenant_id,
    coa_framework,        -- 'coa_ifrs' | 'coa_gaap' | 'coa_mfrs'
