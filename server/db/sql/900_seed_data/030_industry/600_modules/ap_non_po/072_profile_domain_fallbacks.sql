...
--
-- 3 rules per tenant:
--   Wildcard-1: any OPEX  intent + any flow + any doc_type → AP_NON_PO_STANDARD
--   Wildcard-2: any CAPEX intent + any flow + any doc_type → AP_NON_PO_CAPEX
--   Wildcard-3: any ADMIN intent + any flow + any doc_type → AP_NON_PO_STANDARD
--
...
BEGIN
    ...
    RAISE NOTICE 'blueprint/072_profile_domain_fallbacks: up to 3 wildcard rules seeded per active tenant';
