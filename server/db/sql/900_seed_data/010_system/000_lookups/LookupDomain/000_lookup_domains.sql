...
VALUES
    ...
    ('control.book_posting_rule_status',
     'Book posting rule status',
     'Lifecycle states for control.book_posting_rule.',
     'control', false, 'active',
     '00000000-0000-0000-0000-000000000000'),
    ...
    ('master.tenant_status',
     'Tenant Status',
     'Lifecycle states for the master.tenant table. Transitions enforced by fn_guard_tenant_status_transition().',
     'master', false, 'active',
     '00000000-0000-0000-0000-000000000000'),

    ('master.principal_status',
     'Principal Status',
     'Lifecycle states for master.principal. Controls login access and data visibility.',
     'master', false, 'active',
     '00000000-0000-0000-0000-000000000000'),
    ...
    ('master.legal_entity_status',
     'Legal entity status',
     'Lifecycle states for master.legal_entity.',
     'master', false, 'active',
     '00000000-0000-0000-0000-000000000000'),
    ...
    ('master.company_code_status',
     'Company code status',
     'Lifecycle states for master.company_code.',
     'master', false, 'active',
     '00000000-0000-0000-0000-000000000000'),
    ...
    ('master.cost_center_status',
     'Cost center status',
     'Lifecycle states for master.cost_center.',
     'master', false, 'active',
     '00000000-0000-0000-0000-000000000000'),
    ...
    ('master.profit_center_status',
     'Profit center status',
     'Lifecycle states for master.profit_center.',
     'master', false, 'active',
     '00000000-0000-0000-0000-000000000000'),
    ...
    ('master.site_status',
     'Site status',
     'Lifecycle states for master.site.',
     'master', false, 'active',
     '00000000-0000-0000-0000-000000000000'),
    ...
    ('master.warehouse_status',
     'Warehouse status',
     'Lifecycle states for master.warehouse.',
     'master', false, 'active',
     '00000000-0000-0000-0000-000000000000'),
    ...
    ('master.chart_of_account_status',
     'Chart of account status',
     'Lifecycle states for master.chart_of_account.',
     'master', false, 'active',
     '00000000-0000-0000-0000-000000000000'),
    ...
    ('master.gl_account_status',
     'GL account status',
     'Lifecycle states for master.gl_account.',
     'master', false, 'active',
     '00000000-0000-0000-0000-000000000000'),
    ...
    ('master.project_status',
     'Project status',
     'Lifecycle states for master.project.',
     'master', false, 'active',
     '00000000-0000-0000-0000-000000000000'),
    ...
    ('master.project_item_status',
     'Project item status',
     'Lifecycle states for master.project_item.',
     'master', false, 'active',
     '00000000-0000-0000-0000-000000000000'),
    ...
    ('master.fiscal_period_status',
     'Fiscal period status',
     'Lifecycle states for master.fiscal_period.',
     'master', false, 'active',
     '00000000-0000-0000-0000-000000000000'),
    ...
    ('master.ledger_book_status',
     'Ledger book status',
     'Lifecycle states for master.ledger_book.',
     'master', false, 'active',
     '00000000-0000-0000-0000-000000000000'),
    ...
    ('master.company_code_book_assignment_status',
     'Book assignment status',
     'Lifecycle states for master.company_code_book_assignment.',
     'master', false, 'active',
     '00000000-0000-0000-0000-000000000000'),
    ...
    ('master.customer_status',
     'Customer status',
     'Lifecycle states for master.customer.',
     'master', false, 'active',
     '00000000-0000-0000-0000-000000000000'),
    ...
    ('master.supplier_status',
     'Supplier status',
     'Lifecycle states for master.supplier.',
     'master', false, 'active',
     '00000000-0000-0000-0000-000000000000'),
    ...
    ('master.employee_status',
     'Employee status',
     'Lifecycle states for master.employee.',
     'master', false, 'active',
     '00000000-0000-0000-0000-000000000000'),
    ...
    ('master.item_category_status',
     'Product category status',
     'Lifecycle states for master.item_category.',
     'master', false, 'active',
     '00000000-0000-0000-0000-000000000000'),

    ('master.product_status',
     'Product status',
     'Lifecycle states for master.product.',
     'master', false, 'active',
     '00000000-0000-0000-0000-000000000000'),
    ...
    ('master.item_status',
     'Item master status',
     'Lifecycle states for master.item.',
     'master', false, 'active',
     '00000000-0000-0000-0000-000000000000'),
    ...
    ('master.spend_category_status',
     'Spend category status',
     'Lifecycle states for master.spend_category.',
     'master', false, 'active',
     '00000000-0000-0000-0000-000000000000'),
    ...
    ('master.cc_status',
     ...
     'Lifecycle states for master.commodity_classification.',
     'master', false, 'active',
     '00000000-0000-0000-0000-000000000000'),
    ...
    ('document.journal_entry_status',
     'Journal entry status',
     'Lifecycle states for document.journal_entry.',
    ...
    ('governance.book_period_status_status',
     'Book period status',
     'Period open/close state per ledger book.',
     'governance', false, 'active',
     '00000000-0000-0000-0000-000000000000'),
    ...
    ('master.asset_class_status',
     'Asset class status',
     'Lifecycle states for asset classifications. is_extensible=false — '
     'class statuses are platform-defined.',
     'master', false, 'active',
     '00000000-0000-0000-0000-000000000000'),

    ('master.asset_status',
     'Asset status',
     'Lifecycle states for fixed assets. is_extensible=false — '
     'asset lifecycle is compliance-governed.',
     'master', false, 'active',
     '00000000-0000-0000-0000-000000000000'),

    ('master.asset_book_status',
     'Asset book status',
     'Lifecycle states for per-book depreciation profiles. is_extensible=false.',
     'master', false, 'active',
     '00000000-0000-0000-0000-000000000000'),

    ('master.asset_component_status',
     'Asset component status',
     'Lifecycle states for IAS 16 component decompositions. is_extensible=false.',
     'master', false, 'active',
     '00000000-0000-0000-0000-000000000000'),
    ...
    ('control.asset_class_book_policy_status',
     'Asset class book policy status',
     'Lifecycle states for effective-dated book policies (active, inactive, superseded). '
     'is_extensible=false — system lifecycle states.',
     'control', false, 'active',
     '00000000-0000-0000-0000-000000000000'),
    ...
    ('document.asset_transaction_status',
     'Asset transaction status',
     'Lifecycle states for asset transactions. is_extensible=false.',
     'document', false, 'active',
     '00000000-0000-0000-0000-000000000000'),

    ('document.depreciation_run_status',
     'Depreciation run status',
     'Lifecycle states for batch depreciation runs. is_extensible=false.',
     'document', false, 'active',
     '00000000-0000-0000-0000-000000000000'),

    ('document.depreciation_run_line_status',
     'Depreciation run line status',
     'Per-asset line processing states. is_extensible=false.',
     'document', false, 'active',
     '00000000-0000-0000-0000-000000000000'),
...
INSERT INTO control.lookup_domain (code, name, description, source_schema, is_extensible, status, created_by)
VALUES
    ('master.bank_party_status', 'Bank party status', 'Lifecycle states for master.bank_party.', 'master', false, 'active', '00000000-0000-0000-0000-000000000000'),
    ...
    ('master.bank_account_status', 'Bank account status', 'Lifecycle states for master.bank_account.', 'master', false, 'active', '00000000-0000-0000-0000-000000000000'),
    ...
    ('master.bank_account_house_config_status', 'House config status', 'Lifecycle states for house config.', 'master', false, 'active', '00000000-0000-0000-0000-000000000000'),
    ...
    ('control.bank_format_rule_status', 'Bank format rule status', 'Lifecycle states for bank format rules.', 'control', false, 'active', '00000000-0000-0000-0000-000000000000'),
...
INSERT INTO control.lookup_domain (code, name, description, source_schema, is_extensible, status, created_by)
VALUES
    ('master.payment_method_status', 'Payment method status', 'Lifecycle states.', 'master', false, 'active', '00000000-0000-0000-0000-000000000000'),
    ...
    ('control.payment_method_company_policy_status', 'Company policy status', 'Lifecycle states.', 'control', false, 'active', '00000000-0000-0000-0000-000000000000'),
    ('control.bank_interface_profile_status', 'Interface profile status', 'Lifecycle states.', 'control', false, 'active', '00000000-0000-0000-0000-000000000000'),
    ...
    ('control.payment_method_interface_binding_status', 'Binding status', 'Lifecycle states.', 'control', false, 'active', '00000000-0000-0000-0000-000000000000'),
    ('control.payment_settlement_rule_status', 'Settlement rule status', 'Lifecycle states.', 'control', false, 'active', '00000000-0000-0000-0000-000000000000'),
...
INSERT INTO control.lookup_domain (code, name, description, source_schema, is_extensible, status, created_by)
VALUES
    ('master.payment_term_status', 'Payment term status', 'Lifecycle status of a payment term: draft, active, inactive, superseded, archived.', 'master', false, 'active', '00000000-0000-0000-0000-000000000000'),
...
-- ── Holiday Calendar Engine lookup domains ──────────────────────────────────

INSERT INTO control.lookup_domain (code, name, description, source_schema, is_extensible, status, created_by)
VALUES
    ('master.holiday_calendar_status', 'Holiday calendar status', 'Lifecycle status of a holiday calendar: active, inactive, archived.', 'master', false, 'active', '00000000-0000-0000-0000-000000000000')
ON CONFLICT (code) DO NOTHING;
...
VALUES
    ...
    ('master.dimension_type_status', 'Dimension type status', 'Lifecycle states for master.dimension_type. Platform-governed — not tenant-extensible.', 'master', false, 'active', '00000000-0000-0000-0000-000000000000'),
    ('master.dimension_value_status', 'Dimension value status', 'Lifecycle states for master.dimension_value. BLOCKED prevents posting but keeps the value visible for reporting. Platform-governed — not tenant-extensible.', 'master', false, 'active', '00000000-0000-0000-0000-000000000000'),
...
VALUES
    ...
    ('document.purchase_requisition_status', 'Purchase Requisition Status', 'Lifecycle states for document.purchase_requisition. Platform-governed.', 'document', false, 'active', '00000000-0000-0000-0000-000000000000'),
    ...
    ('document.purchase_order_status',       'Purchase Order Status',       'Lifecycle states for document.purchase_order. Platform-governed.', 'document', false, 'active', '00000000-0000-0000-0000-000000000000'),
    ('document.commitment_line_status',      'Commitment Line Status',      'Lifecycle states for document.commitment_line (open, partially_received, fully_received, partially_invoiced, fully_invoiced, closed, cancelled). Platform-governed.', 'document', false, 'active', '00000000-0000-0000-0000-000000000000'),
    ('document.delivery_note_status',        'Delivery Note Status',        'Lifecycle states for document.delivery_note (draft, in_transit, arrived, partially_receipted, fully_receipted, returned, cancelled). Platform-governed.', 'document', false, 'active', '00000000-0000-0000-0000-000000000000'),
    ('document.goods_receipt_status',        'Goods Receipt Status',        'Lifecycle states for document.goods_receipt (draft, pending_approval, approved, posted, reversed, cancelled). Platform-governed.', 'document', false, 'active', '00000000-0000-0000-0000-000000000000'),
    ('document.ses_status',                  'Service Entry Sheet Status',  'Lifecycle states for document.service_entry_sheet (draft, pending_acceptance, accepted, pending_approval, approved, posted, reversed, cancelled). Platform-governed.', 'document', false, 'active', '00000000-0000-0000-0000-000000000000'),
    ...
    ('document.purchase_invoice_status',     'Purchase Invoice Status',     'Lifecycle states for document.purchase_invoice. Platform-governed.', 'document', false, 'active', '00000000-0000-0000-0000-000000000000'),
