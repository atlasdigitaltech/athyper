...
-- Lookup values for domain: control.payment_method_company_policy_status

INSERT INTO control.lookup_value (code, name, domain_code, description, sort_order, is_system, status, created_by)
SELECT v.* FROM (VALUES
    ('active',   'Active',   'control.payment_method_company_policy_status', 'Policy in effect',  10, true, 'active', '00000000-0000-0000-0000-000000000000'::uuid),
    ('inactive', 'Inactive', 'control.payment_method_company_policy_status', 'Policy suspended',  20, true, 'active', '00000000-0000-0000-0000-000000000000')
