...
SELECT v.* FROM (VALUES
    ('active',   'Active',   'control.payment_settlement_rule_status', 'Rule in effect',  10, true, 'active', '00000000-0000-0000-0000-000000000000'::uuid),
    ('inactive', 'Inactive', 'control.payment_settlement_rule_status', 'Rule suspended',  20, true, 'active', '00000000-0000-0000-0000-000000000000')
