...
-- Lookup values for domain: control.bank_interface_profile_status

INSERT INTO control.lookup_value (code, name, domain_code, description, sort_order, is_system, status, created_by)
SELECT v.* FROM (VALUES
    ('active',   'Active',   'control.bank_interface_profile_status', 'Profile in use',   10, true, 'active', '00000000-0000-0000-0000-000000000000'::uuid),
    ('inactive', 'Inactive', 'control.bank_interface_profile_status', 'Profile suspended', 20, true, 'active', '00000000-0000-0000-0000-000000000000')
