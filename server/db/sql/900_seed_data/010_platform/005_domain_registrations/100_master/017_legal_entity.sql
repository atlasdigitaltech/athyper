...
CROSS JOIN (VALUES
    ...
    ('legal_form',                 'legal_form',                 'Legal Form',            'enum',            'zero_or_one', 'master.supplier_legal_form'::text, false, true, NULL::jsonb,              50),
    ('country_code',               'country_code',               'Country of Incorp.',    'text',            'one',         NULL::text,                    true,  true,  NULL::jsonb,                  60),
    ...
    ('regulatory_framework',       'regulatory_framework',       'Regulatory Framework',  'text',            'zero_or_one', NULL::text,                    false, true,  NULL::jsonb,                  80),
    ...
    ('consolidation_method',       'consolidation_method',       'Consolidation Method',  'text',            'one',         NULL::text,                    true,  true,  NULL::jsonb,                  96),
...
CROSS JOIN (VALUES
    ...
    ('business_types',      'business_types',      'Business Types',      'enum[]',  'many',        'master.supplier_business_type'::text,  false, true,  NULL::jsonb,                     126),
