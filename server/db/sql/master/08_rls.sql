-- ============================================================================
-- master/08_rls.sql
-- Concept: Identity RLS — tenant, principal, auth, and contact isolation policies
-- Depends on: 04_tables/003a–003f_master_*.sql, 05_pre_constraint_functions/001_shared.sql
