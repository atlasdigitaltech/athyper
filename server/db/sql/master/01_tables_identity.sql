-- ============================================================================
-- master/01_tables_identity.sql
-- Concept: Identity & Access — tenant root, principals, contacts, RBAC groups
-- Depends on: 01_schemas, 04_tables/001_shared.sql, 04_tables/002_control.sql
