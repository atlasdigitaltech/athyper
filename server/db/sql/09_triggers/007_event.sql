-- 09_triggers/007_event.sql
-- Triggers for event schema notification tables.
-- Depends on: 04_tables/007_event.sql, 900_seed_data/004_control/001_notification_lookups.sql,
