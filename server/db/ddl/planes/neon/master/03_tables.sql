...
COMMENT ON TABLE master.tenant IS
  'Plane-local Neon tenant and RLS root. It is a projection of a canonical subscriber party, not a TrustIAM identity organization; organization aliases never identify tenants.';
