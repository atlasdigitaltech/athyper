...
│
├── 000_bootstrap/              ← platform-global (no schema prefix)
...
### `security/` — Platform-wide security hardening
...
| REVOKE / search_path hardening   | `security/800_security_hardening.sql`   |
| Extension declarations           | `000_bootstrap/001_extensions.sql`      |
| Schema declarations              | `000_bootstrap/002_schemas.sql`         |
| Domain type definitions          | `000_bootstrap/003_domains.sql`         |
...
```
Phase  0  — 000_bootstrap (roles → extensions → schemas → domains)
...
Phase  9  — */07_views
Phase 10  — */08_rls
Phase 11  — security/800_security_hardening.sql
```
