...
-- ── aggregate.wht_supplier_accumulator ─────────────────────────────────────────
-- R7-B: FK constraints for the per-supplier WHT accumulator.
DO $$ BEGIN ALTER TABLE aggregate.wht_supplier_accumulator ADD CONSTRAINT wva_tenant_fk
    FOREIGN KEY (tenant_id) REFERENCES master.tenant (id) ON DELETE CASCADE;
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

DO $$ BEGIN ALTER TABLE aggregate.wht_supplier_accumulator ADD CONSTRAINT wva_company_fk
    FOREIGN KEY (tenant_id, company_code_id)
    REFERENCES master.company_code (tenant_id, id) ON DELETE CASCADE;
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

DO $$ BEGIN ALTER TABLE aggregate.wht_supplier_accumulator ADD CONSTRAINT wva_counterparty_fk
    FOREIGN KEY (counterparty_id) REFERENCES master.principal (id) ON DELETE RESTRICT;
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

DO $$ BEGIN ALTER TABLE aggregate.wht_supplier_accumulator ADD CONSTRAINT wva_jurisdiction_fk
    FOREIGN KEY (tenant_id, jurisdiction_id)
    REFERENCES master.tax_jurisdiction (tenant_id, id) ON DELETE RESTRICT;
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

DO $$ BEGIN ALTER TABLE aggregate.wht_supplier_accumulator ADD CONSTRAINT wva_tax_type_fk
    FOREIGN KEY (tenant_id, tax_type_id)
    REFERENCES master.tax_type (tenant_id, id) ON DELETE RESTRICT;
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

DO $$ BEGIN ALTER TABLE aggregate.wht_supplier_accumulator ADD CONSTRAINT wva_created_by_fk
    FOREIGN KEY (created_by) REFERENCES master.principal (id) ON DELETE RESTRICT;
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

DO $$ BEGIN ALTER TABLE aggregate.wht_supplier_accumulator ADD CONSTRAINT wva_updated_by_fk
