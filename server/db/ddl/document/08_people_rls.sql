...
BEGIN
    ...
    LOOP
        ...
        EXECUTE format('CREATE POLICY tenant_read ON document.%I FOR SELECT USING (shared.current_tenant_id_soft() IS NOT NULL AND tenant_id = shared.current_tenant_id_soft())', v_table);
