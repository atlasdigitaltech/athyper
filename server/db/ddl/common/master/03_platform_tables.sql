-- Common plane-local platform master core.
-- One definition is installed into Studio, Neon, and Mesh; rows remain local
-- to the physical plane unless an explicit projection contract says otherwise.
