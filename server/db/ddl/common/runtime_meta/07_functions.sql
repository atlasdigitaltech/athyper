...
BEGIN
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM runtime_meta.entity_descriptor WHERE applied_release_id=v_target.id) THEN
      RAISE EXCEPTION 'ROLLBACK_DESCRIPTOR_NOT_FOUND' USING ERRCODE='no_data_found';
    END IF;
