...
ALTER TABLE authz.entity_operation_binding
    ADD CONSTRAINT entity_operation_binding_tenant_fk
        FOREIGN KEY (tenant_id) REFERENCES master.tenant (id) ON DELETE RESTRICT,
    ADD CONSTRAINT entity_operation_binding_applied_release_fk
        FOREIGN KEY (applied_release_id) REFERENCES runtime_meta.applied_release (id) ON DELETE RESTRICT,
    ADD CONSTRAINT entity_operation_binding_permission_fk
...
ALTER TABLE authz.entity_operation_scope_binding
    ADD CONSTRAINT entity_operation_scope_binding_operation_fk
        FOREIGN KEY (entity_operation_binding_id)
        REFERENCES authz.entity_operation_binding (id) ON DELETE RESTRICT;
