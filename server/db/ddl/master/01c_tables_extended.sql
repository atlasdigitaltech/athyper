...
COMMENT ON TABLE master.asset_class IS
    ...
    'GL mappings, depreciation parameters, and capitalization thresholds live in control.asset_class_book_policy. '
    'code is bare (PLANT, not ATHQ-AC-PLANT) — unique per tenant, shared across all company codes.';
