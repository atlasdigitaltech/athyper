-- ============================================================================
-- ledger/01_tables.sql
-- Concept: Accounting Ledger — GL balances, tax, FX, budget, inventory movement tables
-- Depends on: 04_tables/003b_master_finance.sql, 04_tables/004_document.sql and sub-tables
