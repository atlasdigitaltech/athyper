 ...
 * without reaching into the runtime's src/foundation/render tree.
 *
 * The concrete implementation lives at
 * server/src/foundation/render/gotenberg-client.ts (Gotenberg HTTP client).
 ...
 *
 * Mirrors src/foundation/render/pdf-renderer-client.ts intentionally; if
