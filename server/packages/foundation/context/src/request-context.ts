// Canonical AsyncLocalStorage request context for server runtimes.
//
...
export type RuntimePlaneKey = "neon" | "mesh" | "admin";

/** Structural IAM binding kept dependency-neutral to avoid foundation -> IAM. */
export interface VerifiedRequestContextBinding {
  readonly planeKey: RuntimePlaneKey;
  readonly realmKey: string;
  readonly tenantId: string;
  readonly principalId: string;
  readonly permissions: { readonly principalFingerprint: string };
...
export interface RequestContext {
  ...
  verified?: VerifiedRequestContextBinding;
}

export function normalizePlaneKey(value: unknown): RuntimePlaneKey | undefined {
 ...
 */
export function derivePlaneFromAzp(value: unknown): RuntimePlaneKey | null {
...
export function bindVerifiedRequestContext(context: VerifiedRequestContextBinding): void {
