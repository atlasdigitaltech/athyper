import { parseAtlasInsightResult, type AtlasInsightResult } from "@athyper/server-contract-ai/insights";
...
export { parseAtlasInsightResult, type AtlasInsightResult } from "@athyper/server-contract-ai/insights";
