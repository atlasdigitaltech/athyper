...
export const atlasAdminSchemas = Object.freeze({
  ...
  retractSource: { type: "object", required: ["sourceId"], properties: { sourceId: string, sourceKind: string, delete: boolean } },
  actionPolicy: { type: "object", required: ["actionCode", "autonomyLevel", "requiresHumanConfirmation"], properties: { actionCode: string, docClass: nullableString, autonomyLevel: { type: "string", enum: ["disabled", "suggest", "assist", "auto"] }, minConfidenceForAuto: nullableNumber, requiresHumanConfirmation: boolean, expectedRevision: string } },
  confidenceThreshold: { type: "object", required: ["actionCode", "minForSuggest", "minForAssist", "minForAuto", "driftWindowHours"], properties: { actionCode: string, docClass: nullableString, modelId: nullableString, minForSuggest: number, minForAssist: number, minForAuto: number, driftAlertBelow: nullableNumber, driftWindowHours: number, expectedRevision: string } },
