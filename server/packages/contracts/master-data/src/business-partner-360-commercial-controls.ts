import type {
  ...
  BusinessPartner360SourceFreshness,
} from "./business-partner-360.js";
import type { VerifiedRequestContext } from "@athyper/server-contract-auth";

export interface BusinessPartner360BankAccountItem {
...
export interface BusinessPartner360CommodityCapabilityItem {
  ...
  readonly commodityCodes: readonly BusinessPartner360CommodityCodeItem[];
  readonly manageHref: string;
}
export interface BusinessPartner360QualificationItem {
  ...
  readonly commodityCapabilityIds?: readonly string[];
  readonly commodityCapabilities?: readonly BusinessPartner360CommodityCapabilityItem[];
  readonly commodityCategoryCode?: string;
  readonly commodityCategoryName?: string;
  readonly commodityCodes?: readonly BusinessPartner360CommodityCodeItem[];
  readonly effectiveFrom?: string;
  readonly effectiveUntil?: string;
...
export interface BusinessPartner360PreferenceItem {
  readonly id: string;
  readonly status: string;
  readonly operatingOrganizationId: string;
  readonly companyCodeId?: string;
...
export interface BusinessPartner360BlockItem {
  readonly id: string;
...
export interface BusinessPartner360AttachmentManifestItem {
...
export interface BusinessPartner360CertificationItem {
  ...
  readonly effectiveFrom?: string;
  readonly effectiveUntil?: string;
  readonly attachment?: BusinessPartner360AttachmentManifestItem;
  readonly manageHref: string;
}
export interface BusinessPartner360SupplierControlsData {
  ...
  readonly scopeState: "missing_scope" | "scoped" | "historical" | "global";
  readonly commodityCapabilities?: readonly BusinessPartner360CommodityCapabilityItem[];
  readonly qualifications: readonly BusinessPartner360QualificationItem[];
  readonly preferences: readonly BusinessPartner360PreferenceItem[];
  readonly blocks: readonly BusinessPartner360BlockItem[];
  readonly certifications: readonly BusinessPartner360CertificationItem[];
}
...
export interface BusinessPartner360CreditReviewData {
  readonly title: "Credit review";
  readonly readOnly: boolean;
  readonly scopeState: "missing_scope" | "scoped" | "historical" | "global";
  readonly currentLimit?: Readonly<{
  ...
  readonly reviews: readonly BusinessPartner360CreditReviewItem[];
  readonly createHref: string;
}
export type BusinessPartner360BankingSection =
  BusinessPartner360Section<BusinessPartner360BankingData>;
export type BusinessPartner360SupplierControlsSection =
  BusinessPartner360Section<BusinessPartner360SupplierControlsData>;
...
export interface BusinessPartner360BankRevealResult {
  readonly bankAccountLinkId: string;
