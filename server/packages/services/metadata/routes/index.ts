...
import { createStudioContractV21Routes } from "./studio-contract-v21.route.js";
...
import { createMeshRuntimeRoutes } from "./mesh-runtime.route.js";
...
export function registerMetadataRoutes(router: Router, deps: MetadataRoutesDeps): Router {
  ...
  createStudioContractV21Routes(router, deps);
  ...
  createMeshRuntimeRoutes(router, { db: deps.db, meshDb: deps.meshDb, auth: deps.auth, logger: deps.logger });
