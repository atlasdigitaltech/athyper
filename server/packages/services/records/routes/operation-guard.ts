 ...
 *
 * @deprecated The workflow runtime `OperationAuthorizer` is the successor for
 * lifecycle/workflow entity operations. Keep this guard for export/import/bulk
 * compatibility until those call sites migrate in Phase 2.
 *
 * Checks that:
 ...
 *
 * This guard is intentionally separate from entity-operations.route.ts so that
 * the write API routes (export, import, bulk-crud) can enforce the same model
 * without going through the operations list endpoint.
 */
