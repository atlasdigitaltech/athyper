...
describe("Finance Setup Phase 2 Stage C tax contract", () => {
  ...
  it("ships governed registration, WHT, simulator and editor interfaces", () => {
    ...
    expect(company).toContain("Tax-resolution simulator");
    expect(company).toContain("posting-role coverage");
