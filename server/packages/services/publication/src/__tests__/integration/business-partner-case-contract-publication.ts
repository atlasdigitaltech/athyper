...
import { BusinessPartnerCaseContractService } from "../../business-partner-case-contract-service.js";
...
const { KyselyLocalProjectionRepository } =
  await import("../../kysely-local-projection-repository.js");
const { VerifiedPublicationArtifactLoader } =
  await import("../../publication-artifact-loader.js");
