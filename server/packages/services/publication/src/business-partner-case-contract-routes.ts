...
const contracts = {
  author: defineRouteContract({
    method: "post",
    path: "/api/studio/business-partner-case-contracts",
    operationId: "studio.authorBusinessPartnerCaseContract",
    summary: "Author an immutable Business Partner case contract revision",
  ...
  simulate: defineRouteContract({
    method: "post",
    path: "/api/studio/business-partner-case-contracts/simulations",
    operationId: "studio.simulateBusinessPartnerCaseContract",
    summary:
      "Dry-run Business Partner case contract compatibility without publication authority",
    tags: ["STUDIO Business Partner Definitions"],
    authenticated: true,
  ...
  get: defineRouteContract({
    method: "get",
    path: "/api/studio/business-partner-case-contracts/:revisionId",
    operationId: "studio.getBusinessPartnerCaseContract",
    summary: "Get a Business Partner case contract revision",
    tags: ["STUDIO Business Partner Definitions"],
    authenticated: true,
    permission: "studio.business_partner_definition.read",
    responses: {
  ...
  publish: defineRouteContract({
    method: "post",
    path: "/api/studio/business-partner-case-contracts/:revisionId/publish",
    operationId: "studio.publishBusinessPartnerCaseContract",
    summary:
      "Approve and queue a signed Business Partner case contract publication",
    tags: ["STUDIO Business Partner Definitions"],
    authenticated: true,
...
export function registerBusinessPartnerCaseContractRoutes(
...
async function audit(
  ...
  await options.audit.record({
    ...
    tenantId: context.tenantId,
    entityType: "business_partner_case_contract",
    entityId,
...
function definitionFailure(
  ...
  if (error instanceof BusinessPartnerDefinitionError) {
