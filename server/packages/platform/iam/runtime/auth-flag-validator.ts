// Bootstrap-time IAM hardening posture validator.
//
...
export interface AuthKernelConfigView {
  readonly iam: {
    readonly defaultRealmKey: string;
    readonly realms: Record<string, {
      readonly iam: {
...
interface Rule {
  ...
  readonly check: (
    ...
    kernelConfig: AuthKernelConfigView | null,
