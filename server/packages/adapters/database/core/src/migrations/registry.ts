// server/packages/adapters/database/core/src/migrations/registry.ts
...
export class MigrationRegistry {
   ...
   *      dev without any configuration (assumes server/packages/adapters/database/
  ...
  private resolveSqlDir(): string {
    ...
    // New package is one level deeper than the old db/ package:
    //   dist/migrations/registry.js → dist/ → core/ → database/ → adapters/ → packages/ → server/ → db/ddl
