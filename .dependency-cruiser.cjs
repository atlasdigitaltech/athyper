...
module.exports = {
  forbidden: [
     ...
     */
    {
      ...
      severity: "error",
      comment:
        "Runtime orchestrates via adapters. Exceptions: kernel logger (pino) and CLI migrate (pg, ioredis).",
      from: {
     ...
     */
    {
      ...
      to: {
        path: "^framework/adapters/(db|memorycache|objectstorage|telemetry)/",
      },
    },
    {
      ...
      to: {
        path: "^framework/adapters/(auth|memorycache|objectstorage|telemetry)/",
      },
    },
    {
     ...
     */
    {
      ...
      severity: "error",
      comment:
        "Products use packages & contracts only. Exception: Next.js API routes and server-side helpers are server code that may import framework.",
      from: {
        path: "^products",
        pathNot: [
          "^products/[^/]+/apps/[^/]+/app/api/",
